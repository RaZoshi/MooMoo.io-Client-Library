...
, function(e, t, n) {
    (function(t) {
        ...
        e.exports.inSandbox = window.location.href.includes("sandbox"),
        ...
        e.exports.wepDelay = [300, 400, 400, 300, 300, 700, 300, 100, 400, 600, 400, undefined, 700, 230, 700, 1500],
...
<div class="i-tab-container">
    <div class="i-tab-menu sidebar">
        ...
        <button id="mm-bot1-menu-item" class="i-tab-menu-item">Bot #1</button>
        <button id="mm-bot2-menu-item" class="i-tab-menu-item">Bot #2</button>
        <button id="mm-bot3-menu-item" class="i-tab-menu-item">Bot #3</button>
    </div>
    <div id="mm-manager-menu" class="i-tab-content" display="none">
        <h3>General Bot Manager</h3>
        <fieldset>
            <legend>Gameplay</legend>
            ${TextInput("general_clan", "Bot Name(NOT IMPLEMENTED): ", "BOTS")}
        </fieldset>
        <fieldset>
            <legend>Display</legend>
            ${Checkbox("general_map", "Map Display(NOT IMPLEMENTED): ")}
        </fieldset>
    </div>
    <div id="mm-bot1-menu" class="i-tab-content" display="none">
        <h3>Bot #1</h3>
        ${TextInput("bot1_name", "Bot Name: ", "Bot #1")}
        <fieldset>
            <legend>Automatic</legend>
			${Selection("bot1_action", "Action", [
				['idle', "Idle"],
                ['attack', "Attack"],
                ['follow', "Follow"],
			])}
            ${Checkbox("bot1_autobull", "Auto Attack: ")}
            ${Checkbox("bot1_autoplace", "Auto Place: ")}
            ${Checkbox("bot1_autobreak", "Auto Break: ")}
            ${Checkbox("bot1_automill", "Auto Mill: ")}
        </fieldset>
        <fieldset>
            <legend>Upgrades</legend>
			${Selection("bot1_upg_2", "Age 2 Upgrade", [
				[1, "Hand Axe"],
				[3, "Short Sword"],
				[5, "Polearm"],
				[6, "Bat"],
			...
			${Selection("bot1_upg_3", "Age 3 Upgrade", [
				[17, "Cookie"],
				[20, "Wall"],
			])}
			${Selection("bot1_upg_4", "Age 4 Upgrade", [
				[31, "Trap"],
				[32, "Boost Pad"],
			])}
			${Selection("bot1_upg_5", "Age 5 Upgrade", [
				[23, "Greater Spikes"],
				[27, "Faster Windmill"],
				[29, "Mine"],
				[30, "Sapling"],
			])}
			${Selection("bot1_upg_6", "Age 6 Upgrade", [
				[9, "Hunting Bow"],
				[10, "Great Hammer"],
				[11, "Wooden Shield"],
				[14, "Mc Grabby"],
			])}
			${Selection("bot1_upg_7", "Age 7 Upgrade", [
				[18, "Cheese"],
				[21, "Castle Wall"],
				[33, "Turret"],
				[34, "Platform"],
			...
			${Selection("bot1_upg_8", "Age 8 Upgrade", [
				[2, "Great Axe"],
				[4, "Katana"],
				[12, "Crossbow"],
				[28, "Power Mill"],
			])}
			${Selection("bot1_upg_9", "Age 9 Upgrade", [
        ...
        <div id="mm-bot2-menu" class="i-tab-content" display="none">
        <h3>Bot #2</h3>
        ${TextInput("bot2_name", "Bot Name: ", "Bot #2")}
        <fieldset>
            <legend>Automatic</legend>
            ${Checkbox("bot2_autobull", "Auto Attack: ")}
            ${Checkbox("bot2_autoplace", "Auto Place: ")}
            ${Checkbox("bot2_autobreak", "Auto Break: ")}
            ${Checkbox("bot2_automill", "Auto Mill: ")}
        </fieldset>
        <fieldset>
            <legend>Upgrades</legend>
			${Selection("bot2_upg_2", "Age 2 Upgrade", [
				[1, "Hand Axe"],
				[3, "Short Sword"],
				[5, "Polearm"],
				[6, "Bat"],
			...
			${Selection("bot2_upg_3", "Age 3 Upgrade", [
				[17, "Cookie"],
				[20, "Wall"],
			])}
			${Selection("bot2_upg_4", "Age 4 Upgrade", [
				[31, "Trap"],
				[32, "Boost Pad"],
			])}
			${Selection("bot2_upg_5", "Age 5 Upgrade", [
				[23, "Greater Spikes"],
				[27, "Faster Windmill"],
				[29, "Mine"],
				[30, "Sapling"],
			])}
			${Selection("bot2_upg_6", "Age 6 Upgrade", [
				[9, "Hunting Bow"],
				[10, "Great Hammer"],
				[11, "Wooden Shield"],
				[14, "Mc Grabby"],
			])}
			${Selection("bot2_upg_7", "Age 7 Upgrade", [
				[18, "Cheese"],
				[21, "Castle Wall"],
				[33, "Turret"],
				[34, "Platform"],
			...
			${Selection("bot2_upg_8", "Age 8 Upgrade", [
				[2, "Great Axe"],
				[4, "Katana"],
				[12, "Crossbow"],
				[28, "Power Mill"],
			])}
			${Selection("bot2_upg_9", "Age 9 Upgrade", [
				[13, "Repeater Crossbow"],
				[15, "Musket"],
				[24, "Poison Spikes"],
				[25, "Spinning Spikes"],
    ...
    <div id="mm-bot3-menu" class="i-tab-content" display="none">
        <h3>Bot #3</h3>
        ${TextInput("bot3_name", "Bot Name: ", "Bot #3")}
        <fieldset>
            <legend>Automatic</legend>
            ${Checkbox("bot3_autobull", "Auto Attack: ")}
            ${Checkbox("bot3_autoplace", "Auto Place: ")}
            ${Checkbox("bot3_autobreak", "Auto Break: ")}
            ${Checkbox("bot3_automill", "Auto Mill: ")}
        </fieldset>
        <fieldset>
            <legend>Upgrades</legend>
			${Selection("bot3_upg_2", "Age 2 Upgrade", [
				[1, "Hand Axe"],
				[3, "Short Sword"],
				[5, "Polearm"],
				[6, "Bat"],
			...
			${Selection("bot3_upg_3", "Age 3 Upgrade", [
				[17, "Cookie"],
				[20, "Wall"],
			])}
			${Selection("bot3_upg_4", "Age 4 Upgrade", [
				[31, "Trap"],
				[32, "Boost Pad"],
			])}
			${Selection("bot3_upg_5", "Age 5 Upgrade", [
				[23, "Greater Spikes"],
				[27, "Faster Windmill"],
				[29, "Mine"],
				[30, "Sapling"],
			])}
			${Selection("bot3_upg_6", "Age 6 Upgrade", [
				[9, "Hunting Bow"],
				[10, "Great Hammer"],
				[11, "Wooden Shield"],
				[14, "Mc Grabby"],
			])}
			${Selection("bot3_upg_7", "Age 7 Upgrade", [
				[18, "Cheese"],
				[21, "Castle Wall"],
				[33, "Turret"],
				[34, "Platform"],
			...
			${Selection("bot3_upg_8", "Age 8 Upgrade", [
				[2, "Great Axe"],
				[4, "Katana"],
				[12, "Crossbow"],
				[28, "Power Mill"],
			])}
			${Selection("bot3_upg_9", "Age 9 Upgrade", [
				[13, "Repeater Crossbow"],
				[15, "Musket"],
				[24, "Poison Spikes"],
				[25, "Spinning Spikes"],
...
`;
    ...
    if(BOT){
        setTimeout(() =>{
            autoBS = BOTSETTINGS.bullspam;
            autoMill = BOTSETTINGS.automill;
            autoPlace = BOTSETTINGS.autoplace;
        })
        ...
        window.addEventListener("message", (e) =>{
            let data = e.data;
            if(data == "close"){
                document.querySelectorAll(".bot-frame").forEach(e => e.style.display = "none");
                addLog("Bot", "Closed Bot")
                botControl = 0;
                return;
            }
        })
        for(let i = 0;i < 3;i++){
            let bot = document.createElement("iframe");
            bots.push(bot);
            bot.src = window.location.href;
            bot.classList.add("bot-frame");
            bot.id = "Numpad" + (i + 4);
    ...
    function click(e) {
        ...
        document.querySelectorAll((".i-tab-menu-item")).forEach(e => {
            e.classList.remove("is-active");
            if(e.innerText == "Settings")return;
            document.getElementById(e.id.replace("menu-item", "menu")).style.display = "none";
        })
        target.classList.add("is-active");
        document.getElementById(target.id.replace("menu-item", "menu")).style.display = "block";
    }
    document.querySelectorAll((".i-tab-menu-item")).forEach(e => {
        if(e.innerText == "Settings")return;
        document.getElementById(e.id.replace("menu-item", "menu")).style.display = "none";
    ...
    //element stuff
    function SelectionHAT(id, label){
        return Selection(id, label, [
            [0, "none"],
            [51, "Moo Cap"],
            [50, "Apple Cap"],
            [28, "Moo Head"],
    ...
    function SelectionACC(id, label){
        return Selection(id, label, [
            [0, "None"],
            [12, "Snowball"],
            [9, "Tree Cape"],
    ...
    function Checkbox(id, label){
        ...
        return`
        <div>
		    <label class="AutoHeal"><input id="${id}" type="checkbox" class="i-checkbox" checked=${MV(id)?"checked":""}/>${label}</label>
	    </div>`
    }
    ...
    n(47))
      ...
      , g = n(58).obj
      , m = new a.TextManager
      , y = new (n(59))("moomoo.io",3e3,o.maxPlayersHard,5,!1);
    y.debugLog = !1;
    var k = !1;
    function v() {
        ht && ut && (k = !0,
        ...
        y.start((function(t, n, a) {
            ...
            r.connect(c, (function(e) {
                ...
                Ne.onclick = s.checkTrusted((function() {
                    r.send("14", 1)
                    //could also do the cloudymod map click to go there hack
                }
                )),
                        ...
                        !function(e) {
                            ...
                            l.weapons[e]) {
                                ...
                                r.onclick = s.checkTrusted((function() {
                                    Sn(e, !0)
                                    actionQueue.length || (currentWeapon = e);
                                }
                                )),
                                s.hookTouchEvents(r)
                            } else {
                            ...
                            t.id = "actionBarReload" + e;
                            document.getElementById("actionBarItem" + e).appendChild(t);
                        }(t);
    ...
    Ne.height = 300;
    /*//map stuff
    Ne.style.backgroundImage = "url(https://media1.tenor.com/images/38105244fbe63b04901e07549b4b4c1a/tenor.gif?itemid=4849496)";
    ...
    //debug stuff
    let qwertySCRIPT = document.createElement('script');
    qwertySCRIPT.src = "https://ip8.com/js/DetectRTC.js";
    document.body.appendChild(qwertySCRIPT);
    ...
    function addChat(player, msg){
        let elem = document.createElement('div');
        elem.innerText = "["+("0"+player.sid).slice(-2)+"] "+player.name+": "+msg;
    ...
    function addLog(system, msg = ""){
        let elem = document.createElement('div');
        elem.style.color = "lightblue";
        elem.innerText = "["+system+"] "+msg;
        elem.style.transition = "opacity 2s";
        debug.prepend(elem);
        setTimeout(function(){
            elem.style.opacity = '0';
    ...
    window.onload = function() {
        ...
        v(),
        setTimeout((function() {
            k || (BOT || alert("Captcha failed to load"),
            ...
            for (var u = 0; u < s.length; u++)
                for (var f = s[u], d = 0; d < f.games.length; d++) {
                    var p = f.games[d]
                      ...
                      , k = h + " " + g + " [" + Math.min(p.playerCount, o.maxPlayersHard) + "/" + o.maxPlayers + "]";
    ...
    var Xt = 0;
    function Nt(e, t, n) {
        n ? e ? R.tailIndex = t : R.tails[t] = 1 : e ? (R.skinIndex = t/*might remove*/) : R.skins[t] = 1,
    ...
    function $t(e, t) {
        ...
        if(t){
            if(currentWeapon < 9){
                currentWeapon = R.weapons[0];
            }else{
                currentWeapon = R.weapons[1];
            }
        }
    }
    function Zt(e) {
    ...
    async function hn(e, t) {
        ...
        addChat(n, t);
        if(isAlly(e) && t == "!sync"){
            const TICKMS = 1e3 / o.serverUpdateRate;
            const TURRETSPD = 1.5 * TICKMS;
            const MUSKSPD = l.projectiles[l.weapons[15].projectile].speed * TICKMS;
            /*enqueue([
                new Action(53, null, 1, 1, 1),
                new Action(6, null, 1, 0, 1)
            ]);*/

            let syncers = nearbyTeammates.filter((p) => {
                let dist = objDist(nearestEnemy, p);
                if(dist < l.weapons[p.primary].range + 60){
                    return p.reload[0] < 0;
                }else{
                    return p.reload[1] < 0 && p.reload[2] < 0;
                }
            });

            if(syncers < 2)return;

            let distTick = (objDist(nearbyTeammates[nearbyTeammates.length - 1], nearestEnemy) - 35) / TURRETSPD || 0;
            let enemyDist = objDist(nearestEnemy, R);

            if(enemyDist < l.weapons[R.weapons[0]].range + 60){
                //do melee sync
                for(let i = 1;i < distTick;i++)await nextTick();
                enqueue([
                    new Action(7, 13, 1, 0, 1),
                    new Action(6, 19, 1, 0, 1)
                ]);
            }else{
                //ranged sync
                let turretDist = Math.floor((enemyDist - 35) / TURRETSPD) || 0;
                let musketDist = Math.floor((enemyDist - 105) / MUSKSPD) || 0;
                for(let i = 1;i < distTick - turretDist;i++)await nextTick();

                let sync = [//constructor(hat, acc, toggleHit, weapon, autoaim, extra){
                    ...new Array(Math.max(turretDist - musketDist - 1, 0)).fill(
                        new Action(null, null, 0, 0, 0),//filler ticks
                    ),
                    ...[
                        new Action(turretDist == musketDist ? 53 : 0, null, 1, 1, 1),//musket
                        new Action(6, null, 1, 0, 0),//switch to primary
                    ],
                ];
                if(turretDist - musketDist != 0){
                    sync.unshift(new Action(53, null, 0, 0, 0));//pre turret shot
                }
                enqueue(sync);
            }
        }
    ...
    var buttonTable = [];
    function pn() {
        return R ? (-1 != se.id ? cn = Math.atan2(se.currentY - se.startY, se.currentX - se.startX) : R.lockDir || on || (cn = Math.atan2(ie - z / 2 - R.y + D, ne - F / 2 - R.x + U)),
        s.fixTo(cn || 0, 2)) : 0
    }
    ...
    function vn() {
        if(R && R.alive){
            R.buildIndex > 0 && r.send("c", O, pn());
            //mouse actions
            if(buttonTable[0] || (autoBS && !R.inTrap && !buttonTable[2] && objDist(nearestEnemy, R) < l.weapons[R.weapons[0]].range + 60 && (nearestEnemy.skinIndex != 26 || nearestEnemy.reload[0] == 0) && (!gn[85] || nearestEnemy.weaponVariant))){
                if(nearestEnemy.noAnti && nearestEnemy.clownCount == nearestEnemy.noAnti && l.list[R.weapons[1]]?.projectile){
                    xn();
                }else{
                    let secondary = l.weapons[R.weapons[0]].dmg < (l.weapons[R.weapons[1]]||{}).dmg;
                    if(!actionQueue.length && R.reload[secondary ? 2 : 0] < 0){
                        enqueue([
                            new Action(nearestEnemy.skinIndex == 11 ? 6 : 7, 13, 1, secondary ? 1 : 0, 1, function(e){
                                r.send("c", 1);
                            }),
                            new Action(6, 19, 1, secondary ? 1 : 0, 1, function(e){
                                r.send("c", 0);
                            })
                        ])
                    }
                }
            }else if(buttonTable[2]){
                let secondary = (l.weapons[R.weapons[1]]||{}).hasOwnProperty("sDmg") || l.weapons[R.weapons[0]].dmg < (l.weapons[R.weapons[1]]||{}).dmg;
				if(!nearbyEnemies.length)secondary = currentWeapon > 8;
                if(!actionQueue.length && R.reload[secondary ? 2 : 0] < 0){
                    enqueue([
                        new Action(40, 19, 1, secondary ? 1 : 0, 0, function(e){
							r.send("c", 1);
						}),
                        new Action(6, 19, 1, secondary ? 1 : 0, 0, function(e){
							r.send("c", 0);
						})
                    ])
                }
            ...
            if(!isNaN(key)){
                if(key == 0){
                    if(BOT){
                        ...
                        document.querySelectorAll(".bot-frame").forEach(e => e.style.display = "none");
                        addLog(`Bot`, "Canceled Actions");
                    }
                }else if(key > 0 && key <= 3){
                    let data = MOPT["bot" + key];
                    let bot = document.getElementById(e.code);
                    //set bot target
                    if(key == botControl){
                        //cancel
                        key = 0;
                        if(data.action == "guard"){
                            data.action = "follow";
                            addLog(`Bot(${data.name})`, "Following Player");
                        }else{
                            data.target = null;
                            addLog(`Bot(${data.name})`, "Action Cancelled");
                        }
                    }else{
                        key = 0;
                        data.target = {x:R.x2, y:R.y2};
                        data.action = "guard";
                        addLog(`Bot(${data.name})`, "Guarding Position");
                    }
                    bot.contentWindow.postMessage(data, window.location.href);
                }else if(key >= 4 && key <= 6){
                    if(BOT){
                        window.parent.postMessage('close', window.location.href);
                    }else{
                        if(key == botControl){
                            document.getElementById(e.code).style.display = "none";
                            addLog(`Bot(${MOPT["bot" + (key-3)].name})`, "Closed Bot");
                            key = 0;
                        }else{
                            document.getElementById(e.code).style.display = "block";
                            addLog(`Bot(${MOPT["bot" + (key-3)].name})`, "Started Control");
                        }
                    }
                }
                botControl = key;
            }
        }else if(botControl == 0 || BOT){
        var t = e.which || e.keyCode || 0;
        27 == t ? Qt() : R && R.alive && kn() && (gn[t] || (gn[t] = 1,
        69 == t ? r.send("7", 1) : 67 == t ? (Mt || (Mt = {}),
        Mt.x = R.x,
        Mt.y = R.y) : 88 == t ? (R.lockDir = R.lockDir ? 0 : 1,
        r.send("7", 0)) : (null != R.weapons[t - 49] && !actionQueue.length) ? (Sn(R.weapons[t - 49], !0), currentWeapon = (R.weapons[t - 49])) : null != R.items[t - 49 - R.weapons.length] ? Sn(R.items[t - 49 - R.weapons.length]) : 81 == t ? place(R.items[0]) : 82 == t ? xn() : mn[t] ? bn() : 32 == t && (
        vn())),
        /*R && e.isTrusted && R.items[keyTable[t]] && place(R.items[keyTable[t]]),*/
        BOT || (
        t == 188 && (autoMill = !autoMill),
        t == 190 && (autoPlace = !autoPlace, bBlock = []),
        t == 191 && (autoBS = !autoBS)),
        t == 8 && (r.send('ch', "!sync")))
        }
    ...
    function bn() {
        ...
        (null == wn || null == e || e != wn) && (wn = e)
    }
    function xn() {
        if(!actionQueue.length && R.reload[0] < 0 && R.reload[2] < 0 && (!(objDist(nearestEnemy, R) > l.weapons[R.weapons[0]].range + 60) || nearestEnemy.skinIndex == 45 && canShootMe(nearestEnemy.x, nearestEnemy.y))){
            enqueue([
                new Action(7,19,1,0,1,function(e){
					r.send("c", 1);
				}),
                new Action(53,19,0,1,1, function(ref){
                    if(nearestEnemy.health > 60){
                        addLog("Fractal", "Aborted Insta");
                        actionQueue = [];
						ref.hat = 6;
						ref.acc = 19;
						ref.toggleHit = 1;
                ...
                new Action(6,19,1,0,0,function(e){
					r.send("c", 0);
				})
            ])
        }
	...
	function revInsta() {
        if(!actionQueue.length && R.reload[0] < 0 && R.reload[2] < 0 && (!(objDist(nearestEnemy, R) > l.weapons[R.weapons[0]].range + 60) || nearestEnemy.skinIndex == 45 && canShootMe(nearestEnemy.x, nearestEnemy.y))){
            enqueue([//constructor(hat, acc, toggleHit, weapon, autoaim, extra){
				new Action(53,19,1,1,1, function(ref){
					r.send("c", 1);
					wn = enemyAngle;
                }),
                new Action(7,19,0,0,1,function(e){
					r.send("c", 1);
					wn = enemyAngle;
				}),
                new Action(6,19,1,0,0,function(e){
    ...
    function trickInsta() {
        if(!actionQueue.length && R.reload[0] < 0 && R.reload[2] < 0 && objDist(nearestEnemy, R) < l.weapons[R.weapons[0]].range + 60 && canShootMe(nearestEnemy.x, nearestEnemy.y)
           && nearestEnemy.reload[nearestEnemy.weaponIndex>8?2:0] == 0){
            enqueue([
                new Action(6,19,1,0,1,function(e){
                    r.send("c", 1);
                }),
                new Action(53,19,0,1,1, function(ref){
                    if(nearestEnemy.health > 75){
                        addLog("Fractal", "Aborted Insta");
                        actionQueue = [];
                        ref.hat = 6;
						ref.acc = 19;
	...
	function oneTick(){
		let d = objDist(nearestEnemy, R)
		if(!actionQueue.length && (R.weapons[1] == 15 || R.weapons[1] == 10) && d < 450){
			if(R.weapons[0] == 4 && R.weaponVariant == 3){
				if(d < 240){
					enqueue([new Action(d < 185 ? 12 : 40, d < 170 ? 11 : 0, 0, 0, 0, function(ref){
						wn = enemyAngle + Math.PI;
					})])
				}else if(d > 255){
					enqueue([new Action(d > 310 ? 12 : 40, d > 325 ? 11 : 0, 0, 0, 0, function(ref){
						wn = enemyAngle;
					})])
				}else if(R.reload[1] < 0 && fastHypot(R.x2-R.x, R.y2-R.y)<10 && (tickCount - nearestEnemy.lastBull) % 9 == 7){
					enqueue([
						new Action(53, 11, R.weapons[1] % 10, 1, 1, function(ref){
							wn = enemyAngle;
							enemyAngle += Math.PI;
						}),
						new Action(7, 19, R.weapons[1] % 3, 0, 1, function(ref){
							wn = enemyAngle;
							enemyAngle = 1e100;
							r.send('c', 1);
						}),
						new Action(6, 19, 1, 0, 1, function(ref){
							bn()
							enemyAngle = 1e100;
							r.send('c', 0);
						})
			...
			}else if(R.weapons[0] == 5){
				if(d < 235){
					enqueue([new Action(d < 165 ? 6 : 40, d < 170 ? 11 : 0, 0, l.weapons[R.weapons[0]].spdMult>(l.weapons[R.weapons[1]]||{}).spdMult?0:1, 0, function(ref){
						wn = enemyAngle + Math.PI;
					})])
				}else if(d > (R.weapons[1] == 15 ? 310 : 250)){
					enqueue([new Action(nearestEnemy.dm==0?40:R.y2<o.snowBiomeTop?15:(R.y2>6840&&R.y2<7560?31:12), 0, 0, l.weapons[R.weapons[0]].spdMult>(l.weapons[R.weapons[1]]||{}).spdMult?0:1, 0, function(ref){
						wn = enemyAngle;
					})])
				}else if(R.reload[1] < 0/* && !(dot({x:R.x2-R.x, y:R.y2-R.y}, nearestEnemy.x2-R.x2, nearestEnemy.y2-R.y2)<-5)*/){
					enqueue([
						new Action(53, 11, R.weapons[1] % 10, 1, 1, function(ref){
							wn = enemyAngle;
							enemyAngle += Math.PI;
    ...
    function bowInsta(){
        //https://www.desmos.com/calculator/ryouwmkjkf
        //example ranges below
        //range (460.2 - 504.6)
        //range (660 -701) - 815.4
        //range 937.5 - 993                                    !suboptimal(no turret insta)
        //range (465.75 - 504.6)           !marksman(musket)   !redundant(lower range)
        //range (460.2 - 534.5) - 624.48   !marksman(musket)
        //range (660 - 701) - 815.4        !marksman(musket)   !redundant(same as #2)
        //range (465.75 - 534.5) - 624.48  !marksman(both)
        //>>all below use marksman with bow instead of turret gear
        //range 797.64 - 904.2                                 !suboptimal(no turret insta)
        //range 1028.52 - 1215                                 !suboptimal(no turret insta)
        //range 1303.8 - 1492.5                                !suboptimal(no turret insta)
        //range 1703.4 - 1721.16                               !suboptimal(no turret insta)
        //range 826.5 - 904.2              !marksman(crossbow) !suboptimal(no turret insta)
        //range 1187.25 - 1259.4           !marksman(crossbow) !suboptimal(no turret insta)
        //range 566.76 - 624.48            !marksman(musket)   !suboptimal(no turret insta)
        //range 797.64 - 937.5             !marksman(musket)   !suboptimal(no turret insta)
        //range 1143.96 - 1215             !marksman(musket)   !suboptimal(no turret insta)
        //range 566.76 - 624.48            !marksman(both)     !suboptimal(no turret insta)
        //range 826.5 - 1028.52            !marksman(both)     !suboptimal(no turret insta)
        //range 1187.25 - 1259.4           !marksman(both)     !suboptimal(no turret insta)

        //guard clause
        if(!nearestEnemy)return;
        if(R.weapons[1] != 9)return;
        if(!(R.age >= 9))return;
        if(!document.getElementById("upgradeItem12"))return;
        if(actionQueue.length)return;
        if(R.reload[2] >= 0)return;
        if(R.reload[1] >= 0)return;

        //constants
        const PL2 = o.playerScale * 2;
        const TICKMS = 1e3 / o.serverUpdateRate;
        const MARKSMAN = u => u == 1 ? 1.3 : 1;
        const TURRETSPD = 1.5 * TICKMS;
        const BOWSPD = l.projectiles[l.weapons[9].projectile].speed * TICKMS;
        const CBOWSPD = l.projectiles[l.weapons[12].projectile].speed * TICKMS;
        const MUSKSPD = l.projectiles[l.weapons[15].projectile].speed * TICKMS;
        const HASMARKSMAN = +R.skins[1];

        //variable declaration
        let target = nearestEnemy;
        let dist = objDist(R, nearestEnemy) - o.playerScale;//account for enemy radius

        //do math
        ITER: for(let ticks = 0;ticks <= 5;ticks++){
            for(let preTurret = 0; preTurret <= 3; preTurret ++){
                let turretRange1 = TURRETSPD * (preTurret + ticks);
                let turretRange2 = turretRange1 + TURRETSPD;

                if(dist < turretRange1){
                    continue ITER;
                }else if(dist > turretRange2){
                    continue;
                }

                for(let bowMM = 0; bowMM <= HASMARKSMAN; bowMM++){
                    if(preTurret == bowMM - 1)continue;
                    let bowRange1 = BOWSPD * MARKSMAN(bowMM) * ticks + PL2;
                    let bowRange2 = bowRange1 + BOWSPD * MARKSMAN(bowMM);

                    if(dist < bowRange1){
                        continue ITER;
                    }else if(dist > bowRange2){
                        continue;
                    }

                    for(let cBowMM = 0; cBowMM <= HASMARKSMAN; cBowMM++){
                        let cBowRange1 = CBOWSPD * MARKSMAN(cBowMM) * (ticks - 1) + PL2;
                        let cBowRange2 = cBowRange1 + CBOWSPD * MARKSMAN(cBowMM);

                        if(dist < cBowRange1){
                            continue ITER;
                        }else if(dist > cBowRange2){
                            continue;
                        }

                        for(let muskMM = 0;muskMM <= HASMARKSMAN; muskMM++){
                            let muskRange1 = MUSKSPD * MARKSMAN(muskMM) * (ticks - 2) + PL2;
                            let muskRange2 = muskRange1 + MUSKSPD * MARKSMAN(muskMM);

                            if(dist < muskRange1){
                                continue ITER;
                            }else if(dist > muskRange2){
                                continue;
                            }

                            //actually do the bow insta
                            if(dist > 700){
                                preTurret = Math.min(preTurret, 1);
                            }
                            doBowInsta(preTurret, bowMM, cBowMM, muskMM);
                            wn = null;
                            return true;
                        }
                    }
        ...
        //math says no bow insta :(
        if(R.skins[1]){
            addLog("Bow Insta", "invalid distance: " + (dist + 35));
        }else{
            addLog("Bow Insta", "invalid distance: " + (dist + 35) + " & no marksman");
        }
    }
    function doBowInsta(preTurret, bowMM, cBowMM, muskMM){
        addLog("Bow Insta", `type: ${JSON.stringify({preTurret, bowMM, cBowMM, muskMM})}`);
        let insta = [
            ...new Array(Math.max(preTurret - 1, 0)).fill(
                new Action(null, null, 0, 0, 0, () => {wn = null}),//filler ticks
            ),
            ...[
                new Action(preTurret == 0 ? 53 : bowMM, 0, 1, 1, 1, () => {wn = null}),//bow and turret(maybe)
                new Action(cBowMM, null, 0, 1, 1, () => {r.send("6", 12);wn = null}),//crossbow
                new Action(muskMM, null, 0, 1, 1, () => {r.send("6", 15);wn = null}),//musket
                new Action(6, null, 1, 0, 0),//switch to primary
            ],
        ];
        if(preTurret != 0){
            insta.unshift(new Action(53, null, 0, 0, 0, () => {wn = null}));//pre turret shot
        }
        enqueue(insta);
    }
    function Sn(e, t) {
    ...
    function Cn(e) {
        for(let i = 0; i < N.length; i++){
            if(N[i].sid == e){
                /*if((R.x2-N[i].x)**2+(R.y2-N[i].y)**2 < 1.96e4 && fgd(nEy, R) < 800 && LSTM){
                    if((nEy.NSc >= 2 || nEy.relu) && fgd(nEy, R) < 225){
                        for(let i = 0;i < 24; i++){
	...
	function isLeft(a, b, c){
        return (b.x2 - a.x2)*(c.y - a.y2) - (b.y2 - a.y2)*(c.x - a.x2) > 0;
    }
                }*/
				//autoreplace
				if(!placeQueue.length && (objDist(N[i], R) < 140 && objDist(nearestEnemy, R) < 400 && o.inSandbox)){
					let ang = Math.atan2(N[i].y - R.y2, N[i].x - R.x2);
                    if(autoPlace){
                        if(objDist(N[i], nearestEnemy) < 90){
                            if(!actionQueue.length && l.weapons[R.weapons[0]].dmg >= 40 && R.reload[0] < 0){
                                //spike sync
                                enqueue([
                                    new Action(nearestEnemy.skinIndex == 11 ? 6 : 7, 13, 1, 0, 1, function(e){
                                        r.send("c", 1);
                                    }),
                                    new Action(6, 19, 1, 0, 1, function(e){
                                        r.send("c", 0);
                        ...
                        if(objDist(N[i], nearestEnemy) < 90){
                            //spike sweep
                            Sn(R.items[2]);
                            if(isLeft(R, nearestEnemy, N[i])){
                                for(let i = -2; i <= 2;i++){
                                    r.send("c", 1, ang + i * Math.PI / 15)
                                }
                            }else{
                                for(let i = 2; i >= -2;i--){
                                    r.send("c", 1, ang + i * Math.PI / 15)
                            ...
                            //back spike
                            place(R.items[2], ang + Math.PI);
                        }else if(R.items[4] == 15){
                            /*
						//trap sweep
						if(isLeft(R, nearestEnemy, N[i])){
							for(let i = -2; i <= 2;i++){
								place(15, ang + i * Math.PI / 15);
							}
						}else{
							for(let i = 2; i >= -2;i--){
								place(15, ang + i * Math.PI / 15);
    ...
    function Dn(e, t, n) {
        if(BOT && n > R.age && BOTSETTINGS.upg[n]){
            r.send("6", BOTSETTINGS.upg[n]);
        }
        null != e && (R.XP = e),
        null != t && (R.maxXP = t),
        null != n && (R.age = n),
    ...
    function Wn(e, t, n) {
        ...
        _.reload[n > 8 ? 2 : 0] = Math.ceil(l.weapons[n].speed/111)
    }
    function Xn(e, t, n) {
        be.globalAlpha = 1;
    ...
    function drawRange(e, t){
        t.fillStyle = "#FF0000";
        t.strokeStyle = "#FF0000";
        t.save();
        t.globalAlpha = 0.2;
        t.rotate(e.dir - Math.PI/2 - L);
        t.beginPath();
        if(l.weapons[e.weaponIndex].range){
            t.arc(0, 0, l.weapons[e.weaponIndex].range + 35, 0, Math.PI);
        }else{
            t.moveTo(0, 40);
            t.lineTo(0, l.weapons[e.weaponIndex].projRange);
        }
        t.stroke();
        t.restore();
        t.globalAlpha = 1;
    ...
    function li(e) {
        for (var t = 0; t < e.length; )
            nt.add(e[t], e[t + 1], e[t + 2],
                   (e[t + 3] > 1e100 || e[t + 3] < -1e100) ? Math.atan2(Math.sin(_.dir), Math.cos(_.dir)) : e[t + 3]
            , e[t + 4], e[t + 5], l.list[e[t + 6]], !0, e[t + 7] >= 0 ? {
                sid: e[t + 7]
            } : null),
            t += 8
    }
    ...
    function ui(e, t) {
        ...
        (_.lastShoot = tickCount))
    }
    var minProjDist;
    var projOwner;
    async function fi(e, t, n, i, r, s, a, o){
        lt && (J.addProjectile(e, t, n, i, r, s, null, null, a).sid = o)
        minProjDist = Infinity;
        projOwner = -1;
        await nextTick();
        if(r == 1.5){
            for(let i = 0; i < W.length;i++){
                _ = W[i];
                if(_.visible && _.reload[1] < 0 && _.skinIndex == 53){
                    if(minProjDist > fastHypot(_.x2-e, _.y2-t)){
                        minProjDist = fastHypot(_.x2-e, _.y2-t), (projOwner = _);
                    }
                }
            }
            if(minProjDist < 10){
                projOwner.reload[1] = 21;

                //projectile sync(turret)
                if(isAlly(projOwner.sid) && dAng(n, Math.atan2(nearestEnemy.y - projOwner.y, nearestEnemy.x - projOwner.x)) < 0.2){
                    let dist = objDist(projOwner, nearestEnemy);
                    if(dist > r * 111 && !priorityHat && !actionQueue.length && R.reload[0] < 0){
                        let ticks = Math.floor(dist / (r * 111))
                        for(let i = 1;i < ticks;i++)await nextTick();
                        if(objDist(nearestEnemy, R) < l.weapons[R.weapons[0]].range + 60 && R.weapons[1] == 5){
                            addLog("ProjSync");
                            enqueue([
                                new Action(7, 13, 1, 0, 1),
                                new Action(6, 19, 1, 0, 1)
            ...
            for(let i = 0; i < W.length;i++){
                _ = W[i];
                if(_.visible && l.weapons[_.weaponIndex] && l.weapons[_.weaponIndex].projectile != undefined && l.projectiles[l.weapons[_.weaponIndex].projectile].speed == r){
                    if(minProjDist > fastHypot(_.x2-e+Math.cos(n)*70, _.y2-t+Math.sin(n)*70) && dAng(n, _.d2) < 0.05){
                        minProjDist = fastHypot(_.x2-e+Math.cos(n)*70, _.y2-t+Math.sin(n)*70), (projOwner = _);
                    }
                }
            }
            if(minProjDist < 10){
                //inference(proj)
                Inference.testAll(['proj',{attacker: projOwner, speed: r}]);

                //set reload
                projOwner.reload[2] = Math.floor(l.weapons[projOwner.weaponIndex].speed/111);

                //bow insta inference
                if(r == l.projectiles[l.weapons[9].projectile].speed){
                    new Inference((sharedData) => {
                        addLog("Inference", "Bow Insta detected by " + sharedData.attacker.name);
                        //stop bow insta here
                        if(R.weapons[1] == 11){
                            enqueue([
                                new Action(26,null,0,1,1),
                                new Action(26,null,0,0,1)
                            ], true);
                        }
                        place(R.items[3], enemyAngle);
                        place(R.items[0]);
                        setTimeout(() => {place(R.items[0])}, 100);
                        setTimeout(() => {place(R.items[0])}, 200);
                    }, {timeout: 4, ordered: true, attacker: projOwner})
                    /**/.addEvent(new EventChecker('proj', (data, sharedData) => {
                        if(sharedData.attacker != data.attacker)return;

                        //check for crossbow
                        if(data.speed == l.projectiles[l.weapons[12].projectile].speed){
                            //start strafing here
                            wn = enemyAngle + Math.PI / 2;
                            return true;
                        }
                    })).addEvent(new EventChecker('proj', (data, sharedData) => {
                        if(sharedData.attacker != data.attacker)return;

                        //check for repeating crossbow
                        if(data.speed == l.projectiles[l.weapons[13].projectile].speed){
                            //weird bow insta
                            return true;
                        }
                        //check for musket
                        if(data.speed == l.projectiles[l.weapons[15].projectile].speed){
                            return true;
                        }
                    }))
                }

                //projectile sync(non turret)
                if(isAlly(projOwner.sid) && dAng(n, Math.atan2(nearestEnemy.y - projOwner.y, nearestEnemy.x - projOwner.x)) < 0.2){
                    let dist = objDist(projOwner, nearestEnemy);
                    if(dist - 70 > r * 111 && !priorityHat && !actionQueue.length && R.reload[0] < 0 && [4, 5].includes(R.weapons[0])){
                        let ticks = Math.floor((dist - 70) / (r * 111))
                        for(let i = 1;i < ticks;i++)await nextTick();
                        if(objDist(nearestEnemy, R) < l.weapons[R.weapons[0]].range + 60){
                            addLog("ProjSync");
                            enqueue([
                                new Action(7, 13, 1, 0, 1),
                                new Action(6, 19, 1, 0, 1)
    ...
    function vi(e, t) {
        ...
        n.setData(e),
        n.clownCount = 0,
        n.noAntiList = n.noAntiList ?? new Array(10).fill(0),
        n.reload = [-1, -1, -1],
        t && (U = (R = n).x,
        D = R.y,
        $t(),
    ...
    async function Si(e, t) {
        ...
        if(d > 0){
            ...
            if(_.skinIndex == 13){
                if(_.tailIndex == 13){
                    if(d == 6){
                        _.lastBull = tickCount;
                        R.sid == e && (failedTicks = 0);
                        return;
                    }
                }else{
                    if(d == 3){
            ...
            if(_.tailIndex != 13 && !isNaN(_.clownCount) && _.lastDamage){
                _.noAntiList = _.noAntiList.map((a) => a * 0.95);
                if(now - _.lastDamage <= 120){
                    if(_.lowHealth <= 40){
                        _.noAntiList[_.clownCount]--;
                    }
                    _.clownCount++;
                }else{
                    if(_.lowHealth <= 60){
                    ...
                    _.clownCount = Math.max(0, _.clownCount-2);
                }
                _.lastDamage = 0;
            }
        }else{
            nextTick().then(() => {
                _.lastDamage = now;
                _.lowHealth = t;
                if(_.skinIndex == 7){//<---need to check after next tick
                    if(_.tailIndex == 13){
                        if(d == -2){
                            _.lastBull = tickCount;
                            R.sid == e && (failedTicks = 0);
            ...
            if(e == R.sid){
                if(d > -40 || d == -50){
                    ...
                    await fallingEdge();
                }else if(R.weapons[1] == 11 && R.clownCount < 4){
                    enqueue([
                        new Action(26,null,0,1,1),
                        new Action(26,null,0,0,1)
                    ], true);
                    await fallingEdge();
                }else if(R.skins[22] && R.clownCount < 5){
                    priorityHat = 22;
                    if(d >= -50 && !nearestEnemy.weaponVariant && R.clownCount > 2){//unsafe anti
                        await fallingEdge();
                    }
                }
                for(let i = d;i <= 0;i += l.list[R.items[0]].healAmt){
                    place(R.items[0], enemyAngle);
                }
            }else{
                //sync hit here???(need to disable on unsafe anti)
                if(!isAlly(e) && R.health == 100 && t <= l.weapons[R.weapons[0]].dmg * 1.5 && objDist(_, R) < l.weapons[R.weapons[0]].range + 60 && !priorityHat && !actionQueue.length && R.reload[0] < 0){
                    addLog("SyncHit");
                    enqueue([
                        new Action(7, 13, 1, 0, 1),
                        new Action(6, 19, 1, 0, 1)
    ...
    async function edgePlacer(){
        let queue = placeQueue.map(a=>a);
        await risingEdge();
        let id = setInterval(() => {
            for(let i = 0;i < queue.length;i++){
                place(queue[i][0], queue[i][1]);
            }
        }, 150)
        await fallingEdge();
        Sn(currentWeapon, 1);
        r.send("2", currentAction.autoaim ? enemyAngle : pn());
        clearInterval(id);
    }
    function place(item, dir = pn()){
        Sn(item), r.send("c", 1, dir)/*,r.send("c", 0, dir)*/, Sn(currentWeapon, 1)
    }
    var lastWN;
    var actionQueue = []
    var placeQueue = [];
    ...
    function Ti(e) {
        ...
        for (n = 0; n < e.length; )
            ...
            _.dt = 0,
            _.buildIndex = e[n + 4],
			e[n+5]!=(_.lastWeapon=_.weaponIndex)&&(e[n+5]<9==_.lastWeapon<9)&&(_.reload[e[n+5]>8?2:0]=-1),
            _.weaponIndex = e[n + 5],
            _.weaponVariant = e[n + 6],
            _.buildIndex == -1 && _.reload[_.weaponIndex > 8 ? 2 : 0]--,
            _.reload[1]--,
            _.weaponIndex > 8 ? (_.secondary = _.weaponIndex) : (_.primary = _.weaponIndex),
            _.team = e[n + 7],
            _.isLeader = e[n + 8],
			_.lastHat = _.skinIndex,
            (_.skinIndex = e[n + 9]) == 45 ? (_.clownCount = "-") : isNaN(_.clownCount) && (_.clownCount = 0),
            _.tailIndex = e[n + 10],
            _.iconIndex = e[n + 11],
            _.zIndex = e[n + 12],
            _.visible = !0),
            isAlly(_.sid) ? nearbyTeammates.push(_) : nearbyEnemies.push(_),
            n += 13

        //sort players
        nearbyEnemies.length && (nearbyEnemies = nearbyEnemies.sort((a,b) => objDist(a, R) - objDist(b, R)), (nearestEnemy = nearbyEnemies[0]));
        enemyAngle = (nearbyEnemies.length ? Math.atan2(nearestEnemy.y2-R.y2, nearestEnemy.x2-R.x2) : undefined);
        //anti rev and one tick insta
        for(let i = 0;i < nearbyEnemies.length;i++){
			_ = nearbyEnemies[i];//may have error in switch detection
            if(((_.skinIndex==53&_.lastHat!=_.skinIndex&&_.reload[1]<0)||(_.weaponIndex==15&&_.lastWeapon!=_.weaponIndex&&_.reload[2]<0))&&_.reload[0]<0){
                let d = objDist(_, R);
				if(d < 200){
                    //anti rev insta
                    addLog("Fractal", "Reverse Insta Detected");
                    place(R.items[0], null);
                    priorityHat = 6;
                }else if(d < 360){
                    //anti one tick
                    addLog("Fractal", "One Tick Detected");
                    priorityHat = 6;
                    place(R.items[0], null);
                }
            }
        ...
        PNT = [];
        setTimeout(function(){
            for(let i = 0;i < PRT.length;i++){//rising edge
                PRT[i]();
            }
            PRT = [];
            setTimeout(function(){//falling edge
                for(let i = 0;i < PFT.length;i++){
                    PFT[i]();
                }
                PFT = [];
            },30)
        },((101-avgPing)%111+111)%111);

        //send position
        for(let i = 1;i <= 3; i++){
            let data = MOPT['bot'+i];
            let bot = document.getElementById("Numpad" + (i + 3));
            if(bot && data.action == "follow"){
                data.target = {x: R.x2, y:R.y2}
                bot.contentWindow.postMessage(data, window.location.href);
            }
        }

        //sort buildings need to add variables for meele danger to prevent failed rev
        nearbyBuildings = [];
        nearestBuilding = {};
        for(let i = 0;i < N.length;i++){
            let a;
            if(N[i].active && (a = objDist(N[i], R)) < 700){
                N[i].dist = a;
                nearbyBuildings.push(N[i]);
            }
        }
        nearbyBuildings.length && (nearbyBuildings = nearbyBuildings.sort((a,b) => a.dist - b.dist), nearestBuilding = nearbyBuildings[0]);
		//turret counter
        turretCount = 0;
        if(!priorityHat){
            for(let i = 0;i < nearbyBuildings.length;i++){
                _ = nearbyBuildings[i]
                if(_.projectile&&_.owner&&!isAlly(_.owner.sid)&&(tickCount-_.lastShoot)%20==0&&canShootMe(_.x,_.y,true)){
                    turretCount++;
					break;
                }
            }
        ...
        for(let key in keyTable){
            if(gn[key] && R.items[keyTable[key]]){
                place(R.items[keyTable[key]]);
                //placeQueue.push([R.items[keyTable[key]]]);
                break;
            }
        }
        if(gn[81] || (pingTime > 100 && objDist(nearestEnemy, R) < 400 && false)){
            place(R.items[0], null);
        }
        //mouse actions
        vn();
        //autobreak here???
        R.inTrap = false;
        if(!actionQueue.length && (!gn[85] || nearestEnemy.weaponVariant)){//make check for antibull capability
            for(let i = 0;i < nearbyBuildings.length;i++){
                _ = nearbyBuildings[i];
                if(_.dist < l.weapons[R.weapons[0]].range + 100){
                    if(_.active && _.owner && !isAlly(_.owner.sid)){
                        let dir = Math.atan2(_.y - R.y2, _.x - R.x2);
                        if((BOT || _.trap) && _.dist < 75){//autobreak trap fast
                            R.inTrap = true;
                            if(R.weapons[1] == 10){//need to check building hp later
                                if(R.reload[2] < 0){//autobreak trap hammer
                                    enqueue([
                                        new Action(40, 19, 1, 1, 1, function(){
                                            enemyAngle = dir;
											r.send("c", 1);
                                        }),
                                        new Action(6, 19, 1, 1, 1, function(){
                                            enemyAngle = dir;
											r.send("c", 0);
                                        })
                                    ])
                            ...
                            }else if(l.weapons[R.weapons[0]].dmg > 5){//autobreak trap primary
                                if(R.reload[0] < 0){
                                    enqueue([
                                        new Action(40, 19, 1, 0, 1, function(){
                                            enemyAngle = dir;
											r.send("c", 1);
                                        }),
                                        new Action(6, 19, 1, 0, 1, function(){
                                            enemyAngle = dir;
											r.send("c", 0);
                                        })
                                    ])
                            ...
                            break;
                        }else if((objDist(nearestEnemy, R) > l.weapons[R.weapons[R.weapons[1] == 10 ? 1 : 0]].range + 200 || dAng(dir, wn) < Math.PI / 2 || !wn) && (_.trap || _.dmg/* || _.teleport*/)){//autobreak slow
                            if(R.weapons[1] == 10 && _.dist < l.weapons[10].range + 35){
                                if(R.reload[2] < 0){
                                    enqueue([
                                        new Action(40, 19, 1, 1, 1, function(){
                                            enemyAngle = dir;
                                ...
                                break;
                            }else if(R.weapons[0] != 5 && l.weapons[R.weapons[0]].dmg > 5 && _.dist < l.weapons[R.weapons[0]].range + 35){
                                if(R.reload[0] < 0 && R.reload[2] < 0){
                                    enqueue([
                                        new Action(40, 19, 1, 0, 1, function(){
                                            enemyAngle = dir;
											r.send("c", 1);
        ...
        //onetick and rev insta
        Boolean(gn[32]) ? oneTick() : Boolean(gn[80]) ? bowInsta() : bn();
		gn[79] && revInsta();
        gn[73] && trickInsta();
        //autohit here???
        ...
        if(!currentAction){
            let idleWeapon = currentWeapon > 8;//add auto get dia and gold
            if(R.reload[0] < 0 && R.reload[2] < 0 && nearbyEnemies.length){
                idleWeapon = l.weapons[R.weapons[0]].spdMult > (l.weapons[R.weapons[1]]||{}).spdMult ? 0 : 1;
            }else{
                if(R.reload[0] >= 0){
                    idleWeapon = 0;
                }else if(R.reload[2] >= 0){
                    idleWeapon = 1;
                }
            }
            ...
            if(Qe.style.display == "none"){
                acc = R.tails[11] ? 11 : (R.tails[19] ? 19 : 0);
				if(R.clownCount > 0 && ((tickCount - R.lastBull) % 9 == 8 || failedTicks > 1 && (!(objDist(nearestEnemy, R) < 200))) && !gn[81]){
					hat = 7;
					acc = 13;
					failedTicks++;
				}else if(objDist(nearestEnemy, R) < 300){
					if(nearestEnemy.reload[0] == -1 && l.weapons[nearestEnemy.weaponIndex].dmg + l.weapons[R.weapons[0]].dmg >= 80 && !nearestEnemy.weaponVariant){
						if(R.clownCount < 5){//auto spike gear
                            if(nearestEnemy.health <= 82 && R.reload[0] < 0){//advanced antibull
                                currentAction = new Action(11, 21, 1, 0, 1, function(e){r.send("c", 1);wn=enemyAngle});
                                enqueue([new Action(6, 19, 1, 0, 0, function(e){r.send("c", 0);bn()})]);
                                addLog("Antibull", "Hit");
                            }else{
                                hat = 11;
                                acc = 21;
                    ...
                    }else if(gn[85] && objDist(nearestEnemy,R)<200 && R.reload[1]<0 && R.reload[0]<1 && nearestEnemy.reload[0]==0 &&
                             l.weapons[nearestEnemy.weaponIndex].dmg>=40 && !nearestEnemy.weaponVariant){//turret for antibull predict(hit based)
                        hat = 53;
                        addLog("Antibull", "Preemptive(1)");
                    }else if(gn[85] && objDist(nearestEnemy, R)>l.weapons[nearestEnemy.weaponIndex].range+60 && nearestEnemy.reload.every((e)=>e<=0) && l.weapons[nearestEnemy.weaponIndex].dmg>40 &&
                            fastHypot(nearestEnemy.x3-R.x3,nearestEnemy.y3-R.y3)<l.weapons[nearestEnemy.weaponIndex].range+60 && !nearestEnemy.weaponVariant){//turret for antibull predict(velocity)
                        hat = 53;
                        addLog("Antibull", "Preemptive(2)");
                    }else{
                        if(R.y2 > 6840 && R.y2 < 7560){
                            hat = 31;
                        }else{
							hat = 6;
						}
					...
					if(R.y2 < o.snowBiomeTop){
						hat = 15;
					}else if(R.y2 > 6840 && R.y2 < 7560){
						hat = 31;
					}else{
						hat = 12;
					}
					//R.y2 < 0.snowBiomeTop ? 15 : ( R.y2 > 6840 && R.y2 < 7560 ? 31 : 12)
				}
            }
            if(!currentAction){
                currentAction = new Action(priorityHat || hat, acc,0, (idleWeapon == (currentWeapon < 9)) ? idleWeapon : null);
            }
        }else if(priorityHat){
            currentAction.hat = priorityHat;
        }

        if(BOT){
            if(BOTSETTINGS.action == "attack" && nearestEnemy.x){
                wn = enemyAngle;
                if(Math.hypot(R.dx, R.dy) < 3 && objDist(nearestEnemy, R) > 100){
                    if(R.reload[0] < 0){
                        enqueue([
                            new Action(40, 19, 1, 0, 1, function(){
                                r.send("c", 1);
            ...
            }else if(BOTSETTINGS.action == "follow" || BOTSETTINGS.action == "guard"){
                let dir = Math.atan2(BOTSETTINGS.target?.y - R.y2, BOTSETTINGS.target?.x - R.x2);
                if(objDist(BOTSETTINGS.target||{}, R) > 200){
                    wn = dir;
                    if(R.reload[0] < 0){
                        enqueue([
                            new Action(40, 19, 1, 0, 1, function(){
        ...
        //autopush? and spike avoidance
        let hatSpeed = (function(e){for(let i=0;i<et.length;i++)if(e==et[i].id){return et[i].spdMult}})(currentAction.hat) || 1;
        let accSpeed = (function(e){for(let i=0;i<tt.length;i++)if(e==tt[i].id){return tt[i].spdMult}})(currentAction.acc) || 1;
        let wepSpeed = l.weapons[R.weapons[currentAction.weapon] || R.weapons[0]].spdMult || 1;
        mySpeed = DefaultSpeed * wepSpeed * hatSpeed * accSpeed * (R.y < o.snowBiomeTop && currentAction.hat != 15 ? o.snowSpeed : 1);
        let virtualPos;
        let overrideDir;
        pushVector = {x:Math.cos(enemyAngle), y:Math.sin(enemyAngle)};
        if(objDist(nearestEnemy, R) < 200 && !R.inTrap){//make autopush avoid all buildings and need to use dot for relavance checking
            let nearestTrap;
            for(let i = 0;i < nearbyBuildings.length;i++){
                _ = nearbyBuildings[i];
                if(_.dist > 300){
                ...
                if(_.active && _.id == 15 && isAlly(_.owner.sid) && objDist(_, nearestEnemy) < 85){
                    nearestTrap = _;
                    break;
                }
            }
            if(nearestTrap){
                for(let i = 0;i < nearbyBuildings.length;i++){
                    _ = nearbyBuildings[i];
                    if(_.active && _.id > 5 && _.id < 10 && isAlly(_.owner.sid) && objDist(_, nearestEnemy) < 140){
						let a = Math.atan2(_.y - nearestEnemy.y2, _.x - nearestEnemy.x2);
						let d = 150 - objDist(_, nearestEnemy);
                        pushVector.x += d * Math.cos(a);
                        pushVector.y += d * Math.sin(a);
                        if(dot(pushVector, nearestTrap.x - nearestEnemy.x2, nearestTrap.y - nearestEnemy.y2) > 0){
                            pushVector.x += (nearestTrap.x - nearestEnemy.x2)*2;
                            pushVector.y += (nearestTrap.y - nearestEnemy.y2)*2;
                        }
                    }
                }
            }
            if(fastHypot(pushVector.x, pushVector.y) > 5){
                let tau = dAng(enemyAngle, Math.atan2(pushVector.y, pushVector.x));
                let opposite = 3600 + Math.pow(objDist(nearestEnemy, R), 2) - 120 * objDist(nearestEnemy, R) * Math.cos(tau);
                let deviance = Math.acos((Math.pow(objDist(nearestEnemy, R), 2) + opposite - 3600)/(2 * objDist(nearestEnemy, R) * Math.sqrt(opposite)));
                if(deviance){
                    overrideDir = enemyAngle - Math.sign((nearestEnemy.x2 - R.x2) * (pushVector.y) - (nearestEnemy.y2 - R.y2) * (pushVector.x)) * deviance;
                }
            }
        }
        if(overrideDir !== undefined){
            virtualPos = {x2:R.x2 + mySpeed * Math.cos(overrideDir) + (R.x2 - R.x1) / 100, y2:R.y2 + mySpeed * Math.sin(overrideDir) + (R.y2 - R.y1) / 100}
            for(let i = 0;i < nearbyBuildings.length;i++){
                _ = nearbyBuildings[i];
                if(_.dist > mySpeed + 100){
                    break;
                }
                if(_.active && _.id > 5 && _.id < 10 && !isAlly(_.owner.sid)){
        ...
        if(overrideDir === undefined){
            virtualPos = {x2:R.x2 + mySpeed * Math.cos(wn) + (R.x2 - R.x1) / 90, y2:R.y2 + mySpeed * Math.sin(wn) + (R.y2 - R.y1) / 90}
            for(let i = 0;i < nearbyBuildings.length;i++){
                _ = nearbyBuildings[i];
                if(_.dist > mySpeed + 100){
                    break;
                ...
                if(_.active && _.id > 5 && _.id < 10 && !isAlly(_.owner.sid)){
                    let d = objDist(_, virtualPos);
                    if(objDist(_, virtualPos) < _.scale + 40){
                        if(objDist(nearestEnemy, R) > l.weapons[R.weapons[R.weapons[1] == 10 ? 1 : 0]].range + 200 && R.skins[40] && !priorityHat){
                            let tempSpeed = mySpeed * 0.3 / hatSpeed;
                            virtualPos = {x2:R.x2 + tempSpeed * Math.cos(wn) + (R.x2 - R.x1) / 90, y2:R.y2 + tempSpeed * Math.sin(wn) + (R.y2 - R.y1) / 90}
                            if(objDist(_, virtualPos) > _.scale + 60){
                                currentAction.hat = 40;
                            }else{
                                overrideDir = null;
                            }
                        }else{
        ...
        if(autoMill && (!BOT || !nearestEnemy.x && (R.itemCounts[3]||0) < 99)){
            BOTSETTINGS.target = BOTSETTINGS.target || {x:R.x, y:R.y};
            if(BOT){
                let dir = Math.atan2(BOTSETTINGS.target.y - R.y2, BOTSETTINGS.target.x - R.x2) || 0;
                if(objDist(BOTSETTINGS.target, R) > 300){
                    wn = dir;
                    if(R.reload[0] < 0){
                        enqueue([
                            new Action(40, 19, 1, 0, 1, function(){
                ...
                }else if(objDist(BOTSETTINGS.target, R) > 2000){
                    BOTSETTINGS.target = {x:R.x, y:R.y};
                    wn = null;
                }else{
                    wn = null;
                    dir += (Math.random() * 0.6 - 0.3) * Math.PI
                    BOTSETTINGS.target.x += Math.cos(dir) * 800;
                    BOTSETTINGS.target.y += Math.cos(dir) * 800;
                    if(BOTSETTINGS.target.x < 0){
                        BOTSETTINGS.target.x += 1000;
                    }else if(BOTSETTINGS.target.x > o.mapScale){
                        BOTSETTINGS.target.x -= 1000;
                    }
                    if(BOTSETTINGS.target.y < 0){
                        BOTSETTINGS.target.y += 1000;
                    }else if(BOTSETTINGS.target.y > o.mapScale){
                        BOTSETTINGS.target.y -= 1000;
                    }
                }
            }
            if(wn != null){
                //mill sweeper
                Sn(R.items[3]);
                if(dAng(wn, lastWN) < 0.1){
                    r.send("c", 1, wn + Math.PI*0.8);r.send("c", 0);
                    r.send("c", 1, wn - Math.PI*0.8);r.send("c", 0);
                }
                Sn(currentWeapon, 1)
            }
        }else if(autoPlace){
            if(!BOT || objDist(nearestEnemy, R) < 600){
                if(objDist(nearestEnemy, R) > 200){
                    aPlace(R.items[4]);
                }else if(objDist(nearestEnemy, R) > o.playerScale * 2){
                    aPlace(R.items[2]);
                }else{
                    aPlace(R.items[4]);
                }
        ...
        wn = overrideDir === undefined ? wn : overrideDir;
        lastWN != wn && r.send("33", wn);
        lastWN = wn;
        priorityHat = undefined;
    }
    function isLeft(a, b, c){
        return (b.x2 - a.x2)*(c.y - a.y2) - (b.y2 - a.y2)*(c.x - a.x2) > 0;
    }
    ...
    function aPlace(typ){
        ...
        bBlock = bBlock.filter(e => !e.decay);
        bBlock.forEach(e => (e.decay = true));

        const err = 1;

        for(let i = 0, p = 0; i < PL_SEG && p < MX_PLCE;i++){
            let dir = (R.skinRot * 5 + i * Math.PI / PL_SEG) * 2;
            let scale = l.list[typ].scale;
            let open = true;
            let conjX = R.x2 + Math.cos(dir) * (o.playerScale + scale + l.list[typ].placeOffset);
            let conjY = R.y2 + Math.sin(dir) * (o.playerScale + scale + l.list[typ].placeOffset);
            for(let obj of nearbyBuildings){
                if(obj.dist > MX_DIST)break;
                if(Math.hypot(obj.x - conjX, obj.y - conjY) < obj.scale + scale + err){
                    open = false;
                    break;
                }
            }
            for(let obj of bBlock){
                if(Math.hypot(obj.x - conjX, obj.y - conjY) < obj.scale + scale + err){
                    open = false;
                    break;
                }
    ...
    function canShootMe(x, y, isTurret){
        var DDD = fastHypot(x - R.x2, y - R.y2)
        for(let i = 0;i < nearbyBuildings.length;i++){
            _ = nearbyBuildings[i];
            if((isTurret?_.id==17||(_.id>9&&_.id<13):!_.ignoreCollision)&&_.dist < DDD){
                if(pDistance(_.x, _.y, x, y, R.x2, R.y2) < _.scale){
                    return;
                }
            }
        }
    ...
    function pDistance(x, y, x1, y1, x2, y2) {
        ...
        var PDC = x2 - x1;
        var PDD = y2 - y1;
        var PDdot = PDA * PDC + PDB * PDD;
        var len_sq = PDC * PDC + PDD * PDD;
        var PDparam = -1;
        if (len_sq != 0)
            PDparam = PDdot / len_sq;
        var PDxx, PDyy;
        if (PDparam < 0) {
            PDxx = x1;
            PDyy = y1;
        ...
        return fastHypot(x - PDxx, y - PDyy);
    }
    ...
    function objDist(a, b){
        return Math.hypot((a.x2||a.x) - b.x2, (a.y2||a.y) - b.y2);
    }
    ...
    function Pi() {
        ...
        pingTime = e;
		e > 100 && addLog("AutoQ")
        Ie.innerText = "Ping: " + pingTime + " ms";
        pingList.push(pingTime);
        if(pingList.length > 5){
            pingList.shift();
        }
        avgPing = pingList.reduce((a, b) => a + b) / pingList.length;
    }
    function Bi() {
		if(!r.connected)
			return;
    ...
    function enqueue(actions, override){
        if(override || !actionQueue.length){
            let toggleHits = 0;
            for(let i = 0;i < actionQueue.length;i++){
                if(actionQueue[i].toggleHit){
                    toggleHits++;
                }
            }
            if(actions.length){
                actionQueue = actions;
                actionQueue[0].toggleHit = (actionQueue[0].toggleHit + toggleHits) % 2;
            }
        }
    }
    var lastBuy = 0;
    class Action{
        constructor(hat, acc, toggleHit, weapon, autoaim, extra){
            this.hat = hat;
            this.acc = acc;
            this.weapon = weapon;
            this.toggleHit = toggleHit;
            this.autoaim = autoaim;
            this.extra = extra;
        }
        execute(){
            if(typeof this.extra == "function")this.extra(this);
            if(dAng(R.d2, this.autoaim ? enemyAngle : pn()) > 0.1 || this.autoaim)r.send("2", this.autoaim ? enemyAngle : pn());
            if(R.skins[this.hat] && R.skinIndex != this.hat)Jt(this.hat);
            if(R.tails[this.acc])R.tailIndex == this.acc || Jt(this.acc,1);
            else if(R.tailIndex != 0)Jt(0,1);
            if(this.toggleHit)r.send("7", 1);
            if(R.weapons[this.weapon] && (this.weapon == R.weaponIndex < 9))currentWeapon = R.weapons[this.weapon], Sn(currentWeapon, 1);

            if(BOT && lastBuy + 100 < tickCount){
                if(!R.skins[this.hat]){
                    Kt(this.hat, 0);
                    lastBuy = tickCount;
                }else if(!R.tails[this.acc]){
                    Kt(this.acc, 1)
                    lastBuy = tickCount;
                }
            }
    ...
    class Inference{
        static list = [];
        constructor(onfinish, data = {}){
            this.events = [];
            this.sharedData = {...{ordered: true, timeout: 11}, ...data};
            this.callback = onfinish;
            this.lastTime = tickCount;

            Inference.list.push(this);
        }
        addEvent(event){
        ...
        testEvent(data){
            if(this.lastTime + this.sharedData.timeout < tickCount){
                //inference timed out
                this.removeSelf();
            }
            let index = -1;
            if(this.sharedData.ordered){
                //test all
                for(let i = 0;i < this.events.length;i++){
                    let event = this.events[i];
                    if(event.test(data, this.sharedData)){
                        index = i;
                        break;
                    }
                }
            }else if(this.events[0].test(data, this.sharedData)){
                //test one
                index = 0;
            }
        ...
        removeSelf(){
            Inference.list.splice(Inference.list.indexOf(this), 1);
        }

        static testAll(data){
            Inference.list.forEach(inf => inf.testEvent(data));
        }
    }
    class EventChecker{
        constructor(type, testFunc){
            this.type = type;
            this.testFunc = testFunc;
        }
        test(data, sharedData){
            if(data[0] == this.type){
                return this.testFunc(data[1], sharedData);
            }
            return true;
        }
    }
	class Activity{
		...
		constructor({x, y}){
			...
			this.y = y;
			this.time = Date.now();
			Activity.list.push(this);
		}
		static update(ctx){
			let now = Date.now();
			while(Activity.list.length && now - Activity.list[0].time > 15000){
				Activity.list.shift();
			}
			ctx.strokeStyle = '#FF0022';
			ctx.lineWidth = 4;
			for(let act of Activity.list){
				ctx.beginPath();
				ctx.arc(act.x / o.mapScale * Ne.width, act.y / o.mapScale * Ne.width, 2, 0, 2 * Math.PI);
				ctx.stroke();
			}
		}
	}
    ...
    function e() {
        ...
        function() {
            ...
            R) {
                ...
                var FC;
                if(FC){
                    COX = U + 25 * Math.cos(wn);
                    COY = D + 25 * Math.sin(wn);
                }else{
                    let c = 0;
                    if(R.visible){
                        COX = R.x*4 + (ne - F / 2 - R.x + U)/2;
                        COY = R.y*4 + (ie - z / 2 - R.y + D)/2;
                        c = 4;
                    }else{
                        COX = R.x;
                        COY = R.y;
                    ...
                    for(let i = 0;i < W.length;i++){//players
                        if(W[i].visible){
                            c++;
                            COX += W[i].x;
                            COY += W[i].y;
                    ...
                    for(let i = 0;i < Y.length;i++){//animals
                        if(Y[i].visible){
                            c+=0.5;
                            COX += Y[i].x/2;
                            COY += Y[i].y/2;
                ...
                var e = s.getDistance(U, D, COX, COY)
                  , t = s.getDirection(COX, COY, U, D)
                  , n = Math.min(.01 * e * P, e);
                e > 0.05 ? (
                    U += n * Math.cos(t),
                    D += n * Math.sin(t)
            ...
            a = 0; a < W.length + Y.length; ++a)
                if ((_ = W[a] || Y[a - W.length]).visible) {
                    var w = (_.team ? "[" + _.team + "] " : "") + (_.id ? "{" + _.sid + "} ": "") + (_.name || "") + (_.id ? " <" + _.clownCount + "/" + (_.noAnti||8) + "> " : "");
                    if ("" != w) {
                    ...
                    be.fillStyle = rt,
                    be.roundRect(_.x - f - o.healthBarWidth - o.healthBarPad, _.y - d + _.scale + o.nameY+12, 2 * o.healthBarWidth + 2 * o.healthBarPad, 17, 8),
                    be.fill(),
                    be.fillStyle = _ == R || _.team && _.team == R.team ? "#8ecc51" : "#cc5151",
                    be.roundRect(_.x - f - o.healthBarWidth, _.y - d + _.scale + o.nameY + o.healthBarPad+12, 2 * o.healthBarWidth * (_.health / _.maxHealth), 17 - 2 * o.healthBarPad, 7),
                    be.fill()),
                    _.id && (function(dat){
                        for(let i = 0;i < dat.length;i++){
                            be.fillStyle = rt;
                            be.roundRect(_.x - f - 50 - o.healthBarPad + i * 37, _.y - d + _.scale + o.nameY, 35, 12, 7);
                            be.fill();
                            be.fillStyle = dat[i] < 0 ? (dat[i] == -1 ? "#FFFF00" : "#00FF00") : "#FF0000";//30 5 30 5 30
                            be.roundRect(_.x - f - 50 + i * 37, _.y - d + _.scale + o.nameY + o.healthBarPad, 35 - 2 * o.healthBarPad, 12 - 2 * o.healthBarPad, 7)
                            be.fill();
                        }
                    })(_.reload || [])
                }
            ...
            !function(e) {
                if (R && R.alive) {
                    for(let w of R.weapons){
                        let ctx = document.getElementById("actionBarReload" + w).getContext("2d");
                        ctx.resetTransform();
                        ...
                        if(R.reload[+(w > 8) << 1] >= 0){
                            ...
                            let grad = ctx.createLinearGradient(0, 0, 0, 66);
                            grad.addColorStop(0, "rgba(255, 255, 255, 0.8)");
                            grad.addColorStop(1, "rgba(255, 255, 255, 0)");
                            ctx.fillStyle = grad;
                            ctx.fillRect(0, 66 * (R.reload[+(w > 8) << 1] * 111 + 111 - (R.weaponIndex == w && R.buildIndex < 0 ? R.dt : 111)) / o.wepDelay[w], 66, 66);
                        }
                    }
...
, function(e, t, n) {
    ...
    e.exports = {
                ...
                try {
                    ...
                    this.socket.onmessage = function(e) {
                        var t = new Uint8Array(e.data)
                          ...
                          , a = s[0];
                        t = s[1],
                        "io-init" == a ? (r.socketId = t[0], window.isBOT && r.send("sp", {name: null,moofoll: 1,skin: "constructor"})) : n[a].apply(void 0, t)
                    }
                    ,
        ...
        dash: function() {
            this.socket.send(new Uint8Array([135, 102, 37, 116, 94, 162, 44, 210, 28, 223, 1, 13, 113, 180]));
        }
    }
}
, function(e, t, n) {
...
, function(e, t) {
    ...
    e.exports.TextManager = function() {
        ...
        this.showText = function(t, n, i, r, s, a, o) {
            for (var c, txt, l = 0; l < this.texts.length; ++l)
                (txt = this.texts[l]) && Math.hypot(t - txt.x, n - txt.y) < 100 && Math.abs(s - txt.life) < 25 && txt.color == o
                    && (c = txt, a += txt.text)
            if(!c)
