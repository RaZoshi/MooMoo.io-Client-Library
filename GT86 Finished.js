 ...
 */
   ...
   , function(e, t, n) {
       (function(t) {
           e.exports.maxScreenWidth = 1920,
               ...
               e.exports.maxPlayers = t && -1 != t.argv.indexOf("--largeserver") ? 80 : 100,
   ...
   , function(e, t, n) {
    ...
    window.location.native_resolution = true;
       ...
       function Zt(e) {
           M = e,
               V = e && window.devicePixelRatio || .56,
               Se.checked = e,
       ...
       function dn(e) {
           ...
           for (var t = 0; t < e.changedTouches.length; t++) {
               ...
               n.identifier == re.id ? (re.id = -1,
                ...
                function pn() {
                    if(autobreak == true && trap == true) {
                        return Math.atan2(trapcoord.y - yo.y, trapcoord.x - yo.x);
       ...
       function vn() {
           R && R.alive && r.send("c", O, R.buildIndex >= 0 ? pn() : null)
                    ...
                    27 == t ? Qt() : R && R.alive && kn() && (gn[t] || (gn[t] = 1, my.traped ? [foodPlacer, boostPlacer, spikePlacer, millPlacer, turretPlacer].forEach(e => e.stop(t)) : [foodPlacer, boostPlacer, spikePlacer, millPlacer, turretPlacer].forEach(e => e.start(t)),
                                                                        69 == t ?
                    ...
                    if (R && R.alive) {
                        var t = e.which || e.keyCode || 0;
                        13 == t ? rn() : kn() && gn[t] && (gn[t] = 0, [foodPlacer, boostPlacer, spikePlacer, millPlacer, turretPlacer].forEach(e => e.stop(t)),
                                                           mn[t] ? bn() : 32 == t &&
                                                           (O = 0, vn()))
                    }
                })));
       ...
       function PL(e, t){
           ...
           if(t != 20){
               Sn(R.items[t]), r.send("c", 1, ang), r.send("c", 0, ang), Sn(R.weaponIndex, 1);
           }else{
               Sn(20), r.send("c", 1, ang), r.send("c", 0, ang), Sn(R.weaponIndex, 1);
           }
       }
       function xn() {
           my.muerte = 1;
        ...
        m.showText(e, t, 50, .18, 500, Math.abs(n), n >= 0 ? "#fff" : "#8ecc51")
                    ...
                    setTimeout(() => {
                        ...
                        if (TickHeal < 0 && TickHeal != 0) {
                            m.showText(TickHealX, TickHealY, 50, .18, 500, "" + Math.abs(TickHeal), TickHeal >= 0 ? "#fff" : "#8ecc51") //e - x // t - y
                        }
                        if (TickDmg > 0) {
                            m.showText(TickDmgX, TickDmgY, 50, .18, 500, "" + Math.abs(TickDmg), TickDmg >= 0 ? "#fff" : "#8ecc51") //e - x // t - y
                        }
                        TickDmg = 0;
                        TickHeal = 0;
                        TickDmgX = 0;
       ...
       function Dn(e, t, n) {
           null != e && (R.XP = e), null != t && (R.maxXP = t), null != n && (R.age = n), n == o.maxAge ? (ze.innerHTML = "MAX AGE", He.style.width = "50%") : (ze.innerHTML = "AGE " + R.age, He.style.width = R.XP / R.maxXP * 100 + "%")
       }
       function Ln(e) {
       ...
       function Wn(e, t, n) {
           (_ = Ii(e)) && (_.startAnim(t, n), n == 10 || n == 14 ? (_.sr = 1,secondaryReload[e] = -111/l.weapons[_.secondary].speed)
                           ...
                           R == _ && R.skins[40] && R.weapons[1] == 10 && !my.bleed && !my.muerte && !my.usaremp && my.traped && (my.bhc++))
       }
...
/*         function Xn(e, t, n) {
      ...
      if (!n || t) {
        ...
        if (
          ...
          (r.globalAlpha = 0.6),
              t || (r.fillStyle = (R && e.owner && e.owner.sid == R.sid ? "" : (e.owner && R && R.team && isAlly(e.owner.sid) ? "#2a2770" : "#780c0c"))),
                       ((e.name.includes("spike") && r.fill() || e.name.includes("pit trap",(r.globalAlpha = .7))) && r.fill()
            );
          (n = i),
          t ||
            (ii[
      ...
      return n;
       ...
       function li(e) {
           for (var t = 0; t < e.length; )
               nt.add(e[t], e[t + 1], e[t + 2], e[t + 3], e[t + 4], e[t + 5], l.list[e[t + 6]], !0, e[t + 7] >= 0 ? {
                   ...
                   (15 == e[t+6] && Math.sqrt(Math.pow((R.y2-e[t + 2]),2)+Math.pow((R.x2-e[t + 1]),2)) < 100 && e[t+7] != R.sid && !isAlly(e[t+7])) && (aT(), (e[t + 1], e[t + 2], e[t])),
                   t += 8
       }
       function aT(){
       ...
       function Si(e, t) {
           ...
           let nAlly = (nEy)?Ii(nEy[0]):null;

           if(nEy[5] == 10 && !ininsta && !autobreak && (nEy.length && fgd(nEy, R) < 179)) {
               Jt(22)
           }
           /*if(nEy[9] == 11 && R.health < 70){
               place(R.items[0]);
           }*/

           if((R.shameCount > 0 && (nEy.length && fgd(nEy, R) > 260)) || (R.shameCount > 5) && autobreak == false){
               Jt(7)
               Jt(11, 1)
           }
           if(nEy[9] == 7 && R.shameCount < 4) {
               place(R.items[0]);
           }
           if(!autobreak && !ininsta && !trap && !my.cc) {
               otherjt()
           }
          /*if(((R.skinIndex != 6 || R.skinIndex != 7) && R.health < 60 && (nEy.length && fgd(nEy, R) > 260))){
               my.usaremp = true;
              Jt(22)
               setTimeout(() => {
                   my.usaremp = false;
       ...
       function hitDetector() {
           var ae = l.weapons[e.weaponIndex].range + 2;
           if(primaryReload[!R.sid] < 1 && primaryReload[R.sid] == 1 && counterinsta && !ininsta && !autobreak) {
               if(fgd(nEy, R) > ae) {
                   hg(11, 21);
               }
           }
               ...
               setInterval(()=>{
           if(window.pingTime > 99 && R && R.shameCount < 5 && R.skinIndex != 7 && autoq == true){
               if(nEy.length && fgd(nEy, R) < 300) {
               Sn(R.items[0]), r.send("c", 1), r.send("c", 0), Sn(oW, 1);
                    ...
                    function Aplace2() {
        if(trap == !true && autobreak == !true && autoplace2 == true && ininsta == false) {
            ...
            for(let i = 0; i < N.length; i++) {
                if(N[i].name == "pit trap") {
                    ...
                    if(N[i].owner.sid == R.sid || isAlly(N[i].owner.sid)) {
       ...
       function curarse(e, t) {
           if ([60, 66, 71].map(s => cS(s)).includes(e)) {
               if(my.AB || my.instadetector){
                   my.AB = false
                   my.instadetector = false
               }else {
                   my.AB = true
                   addF(() => {
                       my.AB = false
           ...
           if(R.skinIndex == 6){
               if ([30, 33, 35, 34, 38, 40].includes(e) && W.filter(item => fgdo(item, R) < 300 && item.sid != R.sid &&(primaryReload[item.sid] == 1 || secondaryReload[item.sid] == 1)).length > 0) {
                   Soldier()
               } else if(R.health - e <= 57 && W.filter(item => fgdo(item, R) < 300 && item.sid != R.sid &&(primaryReload[item.sid] == 1 || secondaryReload[item.sid] == 1)).length > 0){
                   if(e == 57){
                       if(R.shameCount < 7){
                           heal()
                       } else {
           ...
           } else if(R.skinIndex == 7 && [42, 46, 49, 47, 51, 55].includes(e) && W.filter(item => fgdo(item, R) < 300 && item.sid != R.sid &&(primaryReload[item.sid] == 1 || secondaryReload[item.sid] == 1)).length > 0){
               if(R.shameCount < 7){
                   heal()
               } else {
                   Soldier()
               ...
               if(R.health - e <= 75 && W.filter(item => fgdo(item, R) < 300 && item.sid != R.sid &&(primaryReload[item.sid] == 1 || secondaryReload[item.sid] == 1)).length > 0){
                   if(e == 75){
                       if(R.shameCount < 7){
                           heal()
                       } else {
       ...
       function pR(){
           ...
           if(lD > 200 && fgdo(nEy, R) <= 200){
               my.instadetector = true
               addF(() => {
                   my.instadetector = false
               },2)
           }
       ...
       window.boostDist = 150;
        ...
        if (!nEy.length) return;
           ...
           if (!trap && !ininsta && !autobreak && !autoaim) {
               if (element) {
       ...
       setInterval(() => {
            if(autobreak && trap && !ininsta && !click2) {
           if (Math.hypot(x - R.x, y - R.y) > 120) {
               ...
               vn();
                ...
                if(R.weapons[0] == 10 && primaryReload[R.sid] == 1){
            hg(40, 0);
            Sn(R.weapons[0], !0)
                   Jt(40);
            r.send("c", 1, trapdirection);
        } else {
               trapdirection = Math.atan2(trapcoord.y - yo.y, trapcoord.x - yo.x);
               r.send("2", Xn());
               let a = (R.weapons[1] == 10 && !(my.bhc == 2 && primaryReload[R.sid] == 1) ? 10 : R.weapons[0]);
               Sn(a, !0);
               Jt(R.tails[0] ? 0 : 0, 1);
           ...
           if(!trap && !autobreak && !RTR && !ininsta && click == 0 && !click2){
       ...
       function Ti(e) {
           ...
           hats.forEach(x => {
               if(R.points >= x.price && !(R.skins[x.id])) r.send("13c", 1, x.id, 0), hatList.splice(0, 1);
           });
           accessories.forEach(x => {
               if(R.points >= x.price && !(R.tails[x.id])) r.send("13c", 1, x.id, 1), accList.splice(0, 1);
           });
           if(autoplace == true) {
               Aplace();
           }
       ...
       function manageTick(){
           ...
           if(wr == true && rev == true) {
               if(nEy.length && fgd(nEy, R) < 179) {
               insta("reverse")
                   insta2("reverse")
               }
           }
           if(wr == true && rev == false){
               if(R.weapons[1] == 15 &&(nEy.length && fgd(nEy, R) < 179) && (primaryReload[R.sid] == 1 && secondaryReload[R.sid] == 1)){
                   my.muerte = true
               ...
               } else if(R.weapons[1] == 10 && (nEy.length && fgd(nEy, R) < 134) && (primaryReload[R.sid] == 1 && secondaryReload[R.sid] == 1) && nEy[9] != 6){
                   my.muerte = true
                   insta("reverse")
                   insta2("reverse")
               }
           }
           if(tracker.potentialNbl && !my.muerte && R.weapons[1] == 15 &&(nEy.length && fgd(nEy, R) < 179) && (primaryReload[R.sid] == 1 && secondaryReload[R.sid] == 1)){
               insta("nobull")
               insta2("nobull")
           }else if(my.muerte != false){
           }else if(my.traped){
               autobreak = true;
           } else if(my.cc){
           } else {
       ...
       function otherjt(){
           if(R.y >= 6850 && R.y <= 7550 && !autobreak){
               Jt(31)
               Jt(11, 1)
           } else if(nEs.length && fgd(nEy, R) < 210 && !autobreak){
               if(counterinsta) {
                   if(primaryReload[nEy[0]] <= .9 && primaryReload[R.sid] == 1){
                       hg(11, 21);
                   }else{
                       hg(6, 11);
                   }
           ...
           } else if(my.HD || my.instadetector) {
               Jt(22)
           }
           else if((R.shameCount > 0 && (nEy.length && fgd(nEy, R) > 260)) || (R.shameCount > 5) && !autobreak){
               Jt(7)
               Jt(11, 1)
           } else if((fgd(nEy, R) < 260) && nEy.length && !autobreak){
               Jt(6)
               Jt(11,1)
           }else if(R.y <= 2400 && !autobreak){
               Jt(15)
               Jt(11, 1)
           } else if(!autobreak){
               Jt(12)
               Jt(11, 1)
           } else if(nEy[5] == 10 && !ininsta && !autobreak && (nEy.length && fgd(nEy, R) < 179)) {
               Jt(22)
           }
       }
       function fgd(a, b){
            ...
            be.fillRect(0, o.mapScale - o.snowBiomeTop - d, oe, ce - (o.mapScale - o.snowBiomeTop - d))),
               ...
               for (be.globalAlpha = 1, be.fillStyle = "rgba(0, 0, 70, 0.35)", be.fillRect(0, 0, oe, ce), be.strokeStyle = rt, a = 0; a < W.length + Y.length; ++a)
                   if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                       var w = (_.team ? "[" + _.team + "] " : "") + (_.name || "") + (_.isPlayer ? "" : "");
                       var ke = (_.team ? "[" + _.team + "] " : "") + (""+_.shameCount+" / " + _.name + (Ie.innerText = " : " + window.pingTime + " ms") || "") + (_.isPlayer ? "" : "");
                       if ("" != w && shame == false) {
                           if (be.font = (_.nameScale || 30) + "px Hammersmith One",
                               be.fillStyle = _ == R ? "#fff" : R.team && _.team == R.team ? "#fff" : "#fff",
                       ...
                       } else if("" != w && shame == true) {
                       if (be.font = (_.nameScale || 30) + "px Hammersmith One",
                               be.fillStyle = _ == R ? "#fff" : R.team && _.team == R.team ? "#c8f799" : "#fabbbb",
                               be.textBaseline = "middle",
                               be.textAlign = "center",
                               be.lineWidth = _.nameScale ? 11 : 8,
                               be.lineJoin = "round",
                               ...
                               be.shadowBlur = 10,
                               be.shadowOffsetY = 3,
                               be.strokeText(ke, _.x - f, _.y - d - _.scale - o.nameY),
                               be.fillText(ke, _.x - f, _.y - d - _.scale - o.nameY),
                               be.restore());
                       }
                       if(_.isPlayer && _.sid != R.sid && tracer == true){
                                    be.beginPath();
                                    be.save();
                                    be.translate(R.x + (110*Math.cos(Math.atan2(_.y-R.y, _.x-R.x))) - f, R.y+(110*Math.sin(Math.atan2(_.y-R.y, _.x-R.x))) - d);
                                    be.rotate(Math.atan2(_.y-R.y, _.x-R.x)+Math.PI/4);
                                    be.lineWidth = 8;
                                    be.globalAlpha = 0.5;
                                    be.fillStyle = ((isAlly(_.sid) && _.sid != R.sid) ? "#8ecc51" : "black");
                                    be.strokeStyle = "transparent";
                                    be.moveTo(0, 0);
                                    be.lineTo(0, - _.scale);
                                    be.lineTo(- _.scale, - _.scale);
                                    be.fill();
                                    be.stroke();
                                    be.closePath();
                                    be.restore();
                                ...
                                let wR = new Image();
                            if (nearestEnemy) {
                                if (_.sid == nEy[0] && turretReload[yo.id] == 1 && secondaryReload[yo.id] == 1 && wr == true) {
                                    wR.src = "https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Crosshairs_Red.svg/1024px-Crosshairs_Red.svg.png"; //target by King Hans
                                    be.save();
                                    be.translate(_.x - f, _.y - d);
                                    be.beginPath();
                                    be.drawImage(wR, -75/2, -75/2, 75, 75);
                                    be.restore();
                                }
                            }
   ...
   , function(e, t) {
       ...
       e.exports.randInt = function(e, t) {
           ...
           for (var t = "", n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnñopqrstuvwxyz0123456789", i = 0; i < e; i++)
   ...
   , function(e, t) {
       e.exports.AnimText = function() {
           ...
           e.fillStyle = this.color,e.strokeStyle = "it" ,e.font = this.scale + "px Hammersmith One",e.strokeStyle = "it", e.strokeText(this.text, this.x - t, this.y - n),e.strokeStyle = "it", e.fillText(this.text, this.x - t, this.y - n),e.strokeStyle = "it";
           }
                }
       }
           ,
...
let width;
let height;
var aboostspike = false;
setInterval(() => {
    if(aboostspike == true && trap == false && autobreak == false && autoaim == false) {
        if(Math.sqrt(Math.pow((yo.y-nearestEnemy[2]), 2) + Math.pow((yo.x-nearestEnemy[1]), 2)) < 500 && Math.sqrt(Math.pow((yo.y-nearestEnemy[2]), 2) + Math.pow((yo.x-nearestEnemy[1]), 2)) > 300) {
            if(nearestEnemy && nearestEnemy[9] != 40) {
                setTimeout(() => {
                    ns(["33", [nearestEnemyAngle]]);
...
setInterval(() => {
    if(aboostspike == true && trap == false && autobreak == false && autoaim == false) {
        if(Math.sqrt(Math.pow((yo.y-nearestEnemy[2]), 2) + Math.pow((yo.x-nearestEnemy[1]), 2)) < 150) {
            if(nearestEnemy && nearestEnemy[9] != 40) {
                setTimeout(() => {
                    ns(["33", [null]]);
                    ...
                    place(spikeType, nearestEnemyAngle)
                    place(spikeType, nearestEnemyAngle + toRad(0))
                    place(spikeType, nearestEnemyAngle)
                    place(spikeType, nearestEnemyAngle - toRad(135))
                    place(spikeType, nearestEnemyAngle)
                    place(spikeType, nearestEnemyAngle + toRad(280))
                    place(spikeType, nearestEnemyAngle - toRad(20))
                    place(spikeType, nearestEnemyAngle)
...
setInterval(() => {
    if(on360 == true) {
        dns(["2", [199.8715926535897935e+270]]);
    }
}, 0);
    setInterval(()=>{
    if(abullhit == true && ininsta == false && autobreak == false && trap == false && click == false){
        if(isEnemyNear && counterinsta == false) {
        ns(["2", [Math.sqrt(Math.pow((yo.y-nearestEnemy[2]), 2) + Math.pow((yo.x-nearestEnemy[1]), 2)) <= 150]]);
            if(yo.weapon){
                ns(["5", [primary, true]]);
                if (primaryReload[yo.id] == 1) {
                    jt(7);
                    jt(7);
                    acc(0);
                    ns(["c", [1, nearestEnemyAngle]]);
                } else {
                    jt(6);
                    acc(0);
            }
    ...
    } else if(abullhit == true && ininsta == false && autobreak == false && trap == false){
        if(isEnemyNear) {
        ns(["2", [Math.sqrt(Math.pow((yo.y-nearestEnemy[2]), 2) + Math.pow((yo.x-nearestEnemy[1]), 2)) <= range]]);
            if(yo.weapon){
                ns(["5", [primary, false]]);
                ns(["c", [0]]);
            }
    ...
    setInterval(()=>{
    if(wasd == true && ininsta == false){
        if(Math.sqrt(Math.pow((yo.y-nearestEnemy[2]), 2) + Math.pow((yo.x-nearestEnemy[1]), 2)) <= range) {
            if(yo.weapon == 4 || yo.weapon == 5){
                if (primaryReload[yo.id] == 1 && secondaryReload[yo.id] == 1 && turretReload[yo.id] == 1 && nearestEnemy[9] != 6) {
                    insta2("norm");
                }
            }
        }
...
var trapid = null;
var oldHat;
var counterinsta = false;
var oldAcc;
var syncDetect = 0;
var isEnemyNear2 = false;
var enemiesNear;
var click2 = false;
var normalHat;
var normalAcc;
...
function handleMessage(m){
    ...
    if (item == "33") {
        ...
        for(let i = 0; i < data[1].length / 13; i++) {
            ...
            if(playerInfo[0] == yo.id) {
                yo.x = playerInfo[1];
                yo.y = playerInfo[2];
                yo.dir = playerInfo[3];
                yo.object = playerInfo[4];
                yo.weapon = playerInfo[5];
                yo.clan = playerInfo[7];
                yo.isLeader = playerInfo[8];
                yo.hat = playerInfo[9];
                yo.accessory = playerInfo[10];
                yo.isSkull = playerInfo[11];
            } else if(playerInfo[7] != yo.clan || playerInfo[7] === null) {
    ...
    if(item == "6"){
        for(let i = 0; i < data[1].length / 8; i++){
            ...
            if(ObjectData[6] == 15 && ObjectData[7] != yo.id && !isAlly(ObjectData[7])){
                allTraps.push({
                    id: ObjectData[0],
                    x: ObjectData[1],
                    y: ObjectData[2]
            ...
            if(ObjectData[6] == 15 && ObjectData[7] != yo.id && !isAlly(ObjectData[7])){
                if(Math.sqrt(Math.pow((yo.y-ObjectData[2]), 2) + Math.pow((yo.x-ObjectData[1]), 2)) <= 45){
                    trap = true;
                    trapid = ObjectData[0];
                    ...
                    markx = yo.x
                    marky = yo.y
                    posIT = Math.round(Math.sqrt(Math.pow(yo.y - ObjectData[1], 2) + Math.pow(yo.x - ObjectData[2], 2)));
                    autobreak = true;
                }
            }
        }
    ...
    if(data[0] == "ch" && data[1] !== yo.id && data[2].startsWith('!tumamaesmia') && sync == true) {
        if (secondaryReload[yo.id] == 1) {
            ininsta = true;
            autoaim = true;
            ap = true;
            as = false;
    ...
    if(cord) {
         tu.innerHTML = `<p style="font-size: 20px;">x: ${yo.x} y: ${yo.y}</p>`
    }
    if(autobreak && trap){
        posOT = Math.round(Math.sqrt(Math.pow(yo.y - trapcoord.y, 2) + Math.pow(yo.x - trapcoord.x, 2)));
        if(posOT !== posIT && posOT > 90){
            autobreak = false;
            trap = false;
            ns(["c", [0]]);
        }
    } else if(autobreak && trap){
        posOT = Math.round(Math.sqrt(Math.pow(yo.y - trapcoord, 2) + Math.pow(yo.x - trapcoord, 2)));
        if(posOT !== posIT && posOT < 90){
            autobreak = true;
            trap = true;
        }
    ...
    isEnemyNear2 = false;
    if(enemiesNear) {
        nearestEnemy = enemiesNear.sort((a,b) => dist(a, yo) - dist(b, yo))[0];
    }
    if(autoinsta == false) {
        wr = false;
        te.innerHTML = `<p style="font-size: 20px;">Wr: ${wr}</p>`;
    }
        if(wr == true) {
        te.innerHTML = `<p style="font-size: 20px;">Wr: ${wr}</p>`;
    } else if(wr == false) {
    ...
    if(nearestEnemy) {
        nearestEnemyAngle = Math.atan2(nearestEnemy[2]-yo.y, nearestEnemy[1]-yo.x);
        if(Math.sqrt(Math.pow((yo.y-nearestEnemy[2]), 2) + Math.pow((yo.x-nearestEnemy[1]), 2)) < 250) {
            isEnemyNear = true;
        }
        if(Math.sqrt(Math.pow((yo.y-nearestEnemy[2]), 2) + Math.pow((yo.x-nearestEnemy[1]), 2)) < 300) {
            isEnemyNear2 = true;
            if(yo.hat != 7 && yo.hat != 53 && yo.hat != 40 && yo.hat != 22 && yo.hat != 6) {
            }
        }
    }
    if(isEnemyNear2 == false && autobreak == false && yo.hat != 15 && yo.hat != 31 && yo.hat != 6 && yo.hat == 6) {
        acc(11);
        if (yo.y < 2400){
            ns(["13c", [0, 0, 0]]);
            ns(["13c", [0, 15, 0]]);
        } else if (yo.y > 6850 && yo.y < 7550){
            ns(["13c", [0, 0, 0]]);
            ns(["13c", [0, 31, 0]]);
        } else {
            ns(["13c", [0, 0, 0]]);
    ...
    if (!nearestEnemy) {
        ...
        if(yooldy != yo.y || yooldx != yo.x){
            if (walkmillhaha==true) {
                if(Math.sqrt(Math.pow((yo.y-automilly), 2) + Math.pow((yo.x-automillx), 2)) > 100) {
                    place(millType, Math.atan2(yooldy - yo.y, yooldx - yo.x) + toRad(78));
                    place(millType, Math.atan2(yooldy - yo.y, yooldx - yo.x) - toRad(78));
                    place(millType, Math.atan2(yooldy - yo.y, yooldx - yo.x) - toRad(0));
                    ns(["2", [Math.atan2(mouseY - height / 2, mouseX - width / 2)]]);
                    automillx = yo.x;
                    automilly = yo.y;
                } else if(Math.sqrt(Math.pow((yo.y-automilly), 2) + Math.pow((yo.x-automillx), 2)) > 100 && Math.sqrt(Math.pow((yo.y-nearestEnemy[2]), 2) + Math.pow((yo.x-nearestEnemy[1]), 2)) < 500) {
                    place(spikeType, Math.atan2(yooldy - yo.y, yooldx - yo.x) + toRad(78));
                    place(spikeType, Math.atan2(yooldy - yo.y, yooldx - yo.x) - toRad(78));
                    place(spikeType, Math.atan2(yooldy - yo.y, yooldx - yo.x) - toRad(0));
                    ns(["2", [Math.atan2(mouseY - height / 2, mouseX - width / 2)]]);
                    automillx = yo.x;
                    automilly = yo.y;
                }
        ...
        if (data[0] == "ch" && data[1] == yo.id && data[2].split(' ')[0] == "!Coord") {
        alert("x: " + yo.x + " y: " + yo.y)
    }
        if(item == "18" && data[1]) {
        let angle = Math.atan2(yo.y - data[2] , yo.x - data[1]);
        if(data[5] == 3.6) {
            let dir_1 = dir => Math.atan2(Math.sin(dir), Math.cos(dir));
            let a1 = dir_1((Math.atan2(data[2]-yo.y, data[1]-yo.x) + Math.PI + Math.PI) % (Math.PI * 2));
    ...
    if (item == "18") {
        if(Math.sqrt(Math.pow((yo.y-nearestEnemy[2]), 2) + Math.pow((yo.x-nearestEnemy[1]), 2)) < 500) {
            let angle = Math.atan2(yo.y - data[2], yo.x - data[1]);
            if(data[5] == 1.5 && data[4] == 700 && angle + toRad(30) > data[3] && angle - toRad(30) < data[3]) {
                turretCannons++;
                setTimeout(() => {
                    turretCannons--;
                }, data[4] / data[5]);
            }
            if((turretCannons == 2) && (nearestEnemy[5] == 5 || nearestEnemy[5] == 15 || nearestEnemy[5] == 4)) {
                hg(6, 0)
            }
        } else {
            let angleRot = Math.atan2(yo.y - data[2], yo.x - data[1]);
            if(data[5] == 1.5 && data[4] == 700 && angleRot + toRad(30) > data[3] && angleRot - toRad(30) < data[3]) {
                turretCannons++;
                setTimeout(() => {
                    turretCannons--;
                }, data[4] / data[5]);
            }
            if(((turretCannons >= 2) || (turretCannons >= 1))) {
                jt(22);
            }
        }
    }
        if(item == "h" && data[1] == yo.id) {
        if(data[2] < 57 && data[2] > 0 && yo.hat == 11 && counterinsta == true) {
            ininsta = true
            autoaim = true;
            ap = true;
                ns(["13c", [0, 7, 1]]);
            ...
            if(item == "h" && data[1] == nearestEnemy[0] && nearestEnemy[9] != 6) {
        if(data[2] < 55 && data[2] > 0 && spikedmg == true) {
            autoaim = true;
            ap = true;
            hg(7, 21);
            ns(["5", [primary, true]]);
...
document.getElementById('te').innerHTML +=
    `
<p style="font-size: 20px;">Wr: ${wr}</p>

    `

let y3 = document.createElement("div");
y3.id = "ti"
document.body.prepend(y3);
...
document.getElementById('ti').innerHTML +=
    `
<p style="font-size: 20px;">Range: ${autoinsta}</p>
...
document.getElementById('to').innerHTML +=
    `
<p style="font-size: 17px;">Range = U</p>
<p style="font-size: 17px;">Wr = R</p>
<p style="font-size: 17px;">Reverse = Y</p>
<p style="font-size: 17px;">Autoplace = I</p>
<p style="font-size: 17px;">Replacer = T</p>
<p style="font-size: 17px;">CounterInsta = J</p>
<p style="font-size: 17px;">AutoChat = F7, . , 0</p>
<p style="font-size: 17px;">Aimer = Fin</p>
<p style="font-size: 17px;">DMG TXT = Del</p>
<p style="font-size: 17px;">Shame = Num 2</p>
<p style="font-size: 17px;">DMG + = Insert</p>
<p style="font-size: 17px;">Cords = Start</p>
    `
...
let secret = new Uint8Array([159, 18, 223, 1, 76, 246, 7]);

const healer1 = repeater(51, () => {place(foodType, null);
                                    place(foodType, null);
...
document.addEventListener('keydown', (e)=>{
    ...
    if (e.keyCode == 82 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        ns(["6", [7]]); ns(["6", [17]]); ns(["6", [31]]); ns(["6", [23]]); ns(["6", [10]]); ns(["6", [38]]);
    }

   if (e.keyCode == 75 && document.activeElement.id.toLowerCase() !== 'chatbox') {
       place(spawnpadType, yo.dir + toRad(45));
       place(spawnpadType, yo.dir - toRad(45));
   }
       if (e.keyCode == 104 && document.activeElement.id.toLowerCase() !== 'chatbox') {
           setTimeout(() => {
       ws.oldSend(new Uint8Array([135, 102, 37, 116, 94, 162, 44, 210, 28, 223, 1, 13, 113, 180, 825, 839, 30, 845, 92, 83, 382, 696969696, 69345358354375, 589437543597345, 1e+999, 3e+6969]));
           }, 22);
   }
    ...
    if (e.keyCode == 89 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        if(rev == false) {
            rev = true;
            ti.innerHTML = `<p style="font-size: 20px;">Rev Insta: ${rev}</p>`;
        } else {
            rev = false;
            ti.innerHTML = `<p style="font-size: 20px;">Rev Insta: ${rev}</p>`;
        }
        ...
        if(shame == false) {
            shame = true;
            ti.innerHTML = `<p style="font-size: 20px;">Shame: ${shame}</p>`;
        } else {
           shame = false;
            ti.innerHTML = `<p style="font-size: 20px;">Shame: ${shame}</p>`;
        }
        ...
        if(counterinsta == false) {
            counterinsta = true;
            ti.innerHTML = `<p style="font-size: 20px;">Counter Insta: ${counterinsta}</p>`;
        } else {
            counterinsta = false;
            ti.innerHTML = `<p style="font-size: 20px;">Counter Insta: ${counterinsta}</p>`;
        }
        ...
        if(abullhit == false) {
            abullhit = true;
            ti.innerHTML = `<p style="font-size: 20px;">AutoHit: ${abullhit}</p>`;
        } else {
            abullhit = false;
            ti.innerHTML = `<p style="font-size: 20px;">AutoHit: ${abullhit}</p>`;
        }
        ...
        if(plusdmg == false) {
            plusdmg = true;
            ti.innerHTML = `<p style="font-size: 20px;">+Damage: ${plusdmg}</p>`;
        } else {
            plusdmg = false;
            ti.innerHTML = `<p style="font-size: 20px;">+Damage: ${plusdmg}</p>`;
        }
        ...
        if(visual == false) {
            visual = true;
            ti.innerHTML = `<p style="font-size: 20px;">AnimText: ${visual}</p>`;
        } else {
            visual = false;
            ti.innerHTML = `<p style="font-size: 20px;">AnimText: ${visual}</p>`;
        }
    ...
    if (e.keyCode == 219 && document.activeElement.id.toLowerCase() !== 'chatbox') {
               if(sync == false) {
            sync = true;
               ti.innerHTML = `<p style="font-size: 20px;">Sync: ${sync}</p>`;
        } else {
            sync = false;
               ti.innerHTML = `<p style="font-size: 20px;">Sync: ${sync}</p>`;
        }
    ...
    if(e.keyCode == 48){
        var aeSong = new Audio("https://cdn.discordapp.com/attachments/888447750943957053/966100816505237524/the-remedy-for-a-broken-heart-why-am-i-so-in-love.mp3");
            aeSong.play();
    }
        if(e.keyCode == 110){
        var Moon = new Audio("https://cdn.discordapp.com/attachments/888447750943957053/966450675087212544/24kgoldn-mood-official-video-ft-iann-dior.mp3");
            Moon.play();
    }
            if(e.keyCode == 118){
    ...
    if (e.keyCode == 36) {
        ...
        if(visu == true) {
            visu = false;
            ti.innerHTML = `<p style="font-size: 20px;">Smoth Aim: ${visu}</p>`
        } else {
            visu = true;
            ti.innerHTML = `<p style="font-size: 20px;">Smoth Aim: ${visu}</p>`
        }
        ...
        if(spikedmg == false) {
            spikedmg = true;
            ti.innerHTML = `<p style="font-size: 20px;">Spikedmg: ${spikedmg}</p>`
        } else {
            spikedmg = false;
            ti.innerHTML = `<p style="font-size: 20px;">Spikedmg: ${spikedmg}</p>`
        }
    ...
    if (e.keyCode == 73 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        if(autoplace == false) {
            autoplace = true;
            ti.innerHTML = `<p style="font-size: 20px;">Autoplace: ${autoplace}</p>`;
        } else {
            autoplace = false;
            ti.innerHTML = `<p style="font-size: 20px;">Autoplace: ${autoplace}</p>`;
        }
    ...
    if (e.keyCode == 97 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        if(autoplace2 == false) {
            autoplace2 = true;
            ti.innerHTML = `<p style="font-size: 20px;">Autoplace2: ${autoplace2}</p>`
        } else {
            autoplace2 = false;
            ti.innerHTML = `<p style="font-size: 20px;">Autoplace2: ${autoplace2}</p>`
        }
        ...
        if(wasd == false && autoplace != true && settings.replace != true && abullhit != true) {
            wasd = true;
            ti.innerHTML = `<p style="font-size: 20px;">WASD: ${wasd}</p>`;
            autoplace = true;
    ...
    if (e.keyCode == 110 && document.activeElement.id.toLowerCase() !=='chatbox') {
        ...
        setTimeout(() => {
        cjt('Yeah, yeah, yeah, yeah (yeah)')
        }, 13000)
        setTimeout(() => {
        cjt('Why you always in a mood?')
        }, 16000)
        setTimeout(() => {
        cjt('Fuckin round, actin brand new')
        }, 18000)
        setTimeout(() => {
        cjt('I aint tryna tell you what to')
        }, 19000)
        setTimeout(() => {
        cjt('But try to play it cool')
        }, 22000)
        setTimeout(() => {
        cjt('Baby, I aint playing by your')
        }, 24000)
        setTimeout(() => {
        cjt('Everything look better with a')
        }, 25500)
        setTimeout(() => {
        cjt('Why you always in a mood?')
        }, 27000)
        ...
        setTimeout(() => {
        cjt('I could never get attached')
        }, 37000)
        setTimeout(() => {
        cjt('When I start to feel, I unatth')
        }, 38000)
        setTimeout(() => {
        cjt('Somehow always end up feeling')
        }, 41000)
        setTimeout(() => {
        cjt('Baby, I am not your dad,')
        }, 42500)
        setTimeout(() => {
        cjt('it`s not all you want from me')
        }, 44000)
        setTimeout(() => {
        cjt('I just want your company')
        }, 46000)
        setTimeout(() => {
        cjt('Girl, its obvious,')
        }, 49000)
        setTimeout(() => {
        cjt('elephant in the room')
        }, 49500)
        setTimeout(() => {
        cjt('And were a part of it,')
        }, 51000)
        setTimeout(() => {
        cjt('dont act so confused')
        }, 52000)
        setTimeout(() => {
        cjt('And you love startin it,')
        }, 54000)
          setTimeout(() => {
        cjt(`now I'm in a mood`)
        }, 55000)
        setTimeout(() => {
        cjt('Now we arguin in my bedroom')
        }, 56000)
        setTimeout(() => {
        cjt('We play games of love to avoid')
        }, 59000)
        setTimeout(() => {
        cjt(`the depression`)
        }, 62000)
        setTimeout(() => {
        cjt(`We been here before`)
        }, 64000)
        setTimeout(() => {
        cjt(`And I won't be your victim`)
        }, 66000)
        setTimeout(() => {
        cjt(`Why you always in a mood?`)
        }, 68500)
        ...
        setTimeout(() => {
        cjt(`I ain't tryna tell you what to`)
        }, 72000)
        setTimeout(() => {
        cjt(`But try to play it cool`)
        }, 74000)
        setTimeout(() => {
        cjt(`Baby, I ain't playing by your`)
        }, 76000)
        setTimeout(() => {
        cjt(`Everything look better with a`)
        }, 78000)
        ...
        setTimeout(() => {
        cjt(`So why you tryin' to fake`)
        }, 90500)
        setTimeout(() => {
        cjt(`your love on the regular?`)
        }, 91000)
        setTimeout(() => {
        cjt(`When you're falling down,`)
        }, 93000)
        setTimeout(() => {
        cjt(`When you could be blowin`)
        }, 94000)
        setTimeout(() => {
        cjt(`up just like my cellular`)
        }, 94500)
        setTimeout(() => {
        cjt(`I won't ever let a shorty`)
        }, 96000)
        setTimeout(() => {
        cjt(`go and set me up`)
        }, 96600)
        setTimeout(() => {
        cjt(`Only thing I need to know`)
        }, 98500)
        setTimeout(() => {
        cjt(`is if you wet enough`)
        }, 100000)
        setTimeout(() => {
        cjt(`I'm talking slick back, kick`)
        }, 101000)
        setTimeout(() => {
        cjt(`back, gang sippin' Fourties`)
        }, 102000)
        setTimeout(() => {
        cjt(`You keep playin', not`)
        }, 104000)
        setTimeout(() => {
        cjt(`another day with you shorty`)
        }, 105000)
        setTimeout(() => {
        cjt(`Mismatch, bitch, that was`)
        }, 107000)
        setTimeout(() => {
        cjt(`way before you know me`)
        }, 108000)
        setTimeout(() => {
        cjt(`you better save it for me`)
        }, 109000)
        setTimeout(() => {
        cjt(`We play games of love`)
        }, 112000)
        setTimeout(() => {
        cjt(`to avoid the depression`)
        }, 114000)
        setTimeout(() => {
        cjt(`And I won't be your victim`)
        }, 117000)
    ...
    if (e.keyCode == 85 && document.activeElement.id.toLowerCase() !== 'chatbox') {
        if(autoinsta == false) {
            autoinsta = true;
            ti.innerHTML = `<p style="font-size: 20px;">Range: ${autoinsta}</p>`;
        } else {
            autoinsta = false;
            ti.innerHTML = `<p style="font-size: 20px;">Range: ${autoinsta}</p>`;
            wr == false;
        ...
        if(e.keyCode == 82 && autoinsta == true && document.activeElement.id.toLowerCase() !== 'chatbox') {
        if(wr == false) {
            wr = true;
            te.innerHTML = `<p style="font-size: 20px;">Wr: ${wr}</p>`;
        } else {
        ...
        if(autoq == false) {
            autoq = true;
            ti.innerHTML = `<p style="font-size: 20px;">AutoQ: ${autoq}</p>`;
        } else {
            autoq = false;
             ti.innerHTML = `<p style="font-size: 20px;">AutoQ: ${autoq}</p>`;
        }
    }
    if (e.keyCode == 82 && rev == false && autoinsta == false && document.activeElement.id.toLowerCase() !== 'chatbox') {
        autoaim = true;
        ininsta = true;
        if(nearestEnemy && nearestEnemy[9] == 11) {
            as = true;
            as = true;
            hg(53, 21)
            ns(["5", [secondary, true]]);
...
function fourSpawnpad() {
       place(spawnpadType, yo.dir + toRad(135));
       place(spawnpadType, yo.dir + toRad(150));
       place(spawnpadType, yo.dir + toRad(165));
       place(spawnpadType, yo.dir + toRad(180));
       place(spawnpadType, yo.dir + toRad(270));
       place(spawnpadType, yo.dir + toRad(360));
}
...
window.addEventListener("mouseup", (e) => {
    if (e.which == 1) {
        ...
        ns(["13c", [0, 0, 1]]);
        ns(["13c", [0, 0, 0]]);
        if (isEnemyNear == true && counterinsta == true) {
            ns(["13c", [0, 21, 1]]);
            ns(["13c", [0, 6, 0]]);
        } else if (isEnemyNear == true && counterinsta == false) {
            jt(6);
            acc(0)
        } else if (yo.y < 2400) {
            ns(["13c", [0, 11, 1]]);
...
function ChatSpamFC0() {
    ns(["ch", ["Why am I so in love?"]]);
    clearTimeout(ChatSpam0);
    ChatSpam1 = setTimeout(function(){ ChatSpamFC1(); }, 3100);
}
function ChatSpamFC1() {
    ns(["ch", ["Why am I so in love?"]]);
    clearTimeout(ChatSpam1);
    ChatSpam1 = setTimeout(function(){ ChatSpamFC2(); }, 3000);
}
function ChatSpamFC2() {
    ns(["ch", ["Why am I so in love?"]]);
    clearTimeout(ChatSpam2);
    ChatSpam3 = setTimeout(function(){ ChatSpamFC3(); }, 5500);
}
function ChatSpamFC3() {
    ns(["ch", ["I don't know why"]]);
    clearTimeout(ChatSpam3);
    ChatSpam4 = setTimeout(function(){ ChatSpamFC4(); }, 3000);
}
function ChatSpamFC4() {
    ns(["ch", ["Steady tryin' to maintain"]]);
    clearTimeout(ChatSpam4);
    ChatSpam5 = setTimeout(function(){ ChatSpamFC5(); }, 1300);
}
function ChatSpamFC5() {
    ns(["ch", ["Same things that a blood Bitch"]]);
    clearTimeout(ChatSpam5);
...
function ChatSpamFC7() {
    ns(["ch", ["My brain can't fathom what the"]]);
    clearTimeout(ChatSpam7);
...
function ChatSpamFC9() {
    ns(["ch", ["He say, she say, how 'bout me"]]);
    clearTimeout(ChatSpam9);
    ChatSpam10 = setTimeout(function(){ ChatSpamFC10(); }, 1200);
}
function ChatSpamFC10() {
    ns(["ch", [" say?, Get the Visa"]]);
    clearTimeout(ChatSpam10);
    ChatSpam11 = setTimeout(function(){ ChatSpamFC11(); }, 1200);
}
function ChatSpamFC11() {
    ns(["ch", ["Headed to the islands ASAP"]]);
    clearTimeout(ChatSpam11);
    ChatSpam12 = setTimeout(function(){ ChatSpamFC12(); }, 1300);
}
function ChatSpamFC12() {
    ns(["ch", ["What's that on my shawty wrist"]]);
    clearTimeout(ChatSpam12);
    ChatSpam13 = setTimeout(function(){ ChatSpamFC13(); }, 1300);
}
...
function ChatSpamFC14() {
    ns(["ch", ["I'm the type to save a Bitch"]]);
    clearTimeout(ChatSpam14);
    ChatSpam15 = setTimeout(function(){ ChatSpamFC15(); }, 1200);
}
function ChatSpamFC15() {
    ns(["ch", ["Feeling like ET, flying"]]);
    clearTimeout(ChatSpam15);
    ChatSpam16 = setTimeout(function(){ ChatSpamFC16(); }, 1200);
}
function ChatSpamFC16() {
    ns(["ch", ["Out of the Addy"]]);
    clearTimeout(ChatSpam16);
    ChatSpam17 = setTimeout(function(){ ChatSpamFC17(); }, 1200);
}
function ChatSpamFC17() {
    ns(["ch", ["Fucking on shawty, she baddie"]]);
    clearTimeout(ChatSpam17);
    ChatSpam18 = setTimeout(function(){ ChatSpamFC18(); }, 1100);
}
function ChatSpamFC18() {
    ns(["ch", ["Casual convo then at it"]]);
    clearTimeout(ChatSpam18);
    ChatSpam19 = setTimeout(function(){ ChatSpamFC19(); }, 1100);
}
function ChatSpamFC19() {
    ns(["ch", ["I mean I'm better than better,"]]);
    clearTimeout(ChatSpam19);
    ChatSpam20 = setTimeout(function(){ ChatSpamFC20(); }, 1200);
}
function ChatSpamFC20() {
    ns(["ch", ["Maybe I'm lying"]]);
    clearTimeout(ChatSpam20);
    ChatSpam21 = setTimeout(function(){ ChatSpamFC21(); }, 1200);
}
function ChatSpamFC21() {
    ns(["ch", ["I'm sadder than most of y'all"]]);
    clearTimeout(ChatSpam21);
    ChatSpam22 = setTimeout(function(){ ChatSpamFC22(); }, 1200);
}
function ChatSpamFC22() {
    ns(["ch", ["with the money and the freedom"]]);
    clearTimeout(ChatSpam22);
    ChatSpam23 = setTimeout(function(){ ChatSpamFC23(); }, 1200);
}
function ChatSpamFC23() {
    ns(["ch", ["What is money really worth if"]]);
    clearTimeout(ChatSpam23);
    ChatSpam24 = setTimeout(function(){ ChatSpamFC24(); }, 1200);
}
function ChatSpamFC24() {
    ns(["ch", ["I'ma find a perfect balance,"]]);
    clearTimeout(ChatSpam24);
    ChatSpam25 = setTimeout(function(){ ChatSpamFC25(); }, 1200);
}
function ChatSpamFC25() {
    ns(["ch", ["it's gon' take time"]]);
    clearTimeout(ChatSpam25);
    ChatSpam26 = setTimeout(function(){ ChatSpamFC26(); }, 800);
}
function ChatSpamFC26() {
    ns(["ch", ["I heard shawty still in love"]]);
    clearTimeout(ChatSpam26);
    ChatSpam0 = setTimeout(function(){ ChatSpamFC27(); }, 1100);
}
function ChatSpamFC27() {
    ns(["ch", ["through the grape vine"]]);
    clearTimeout(ChatSpam27);
    ChatSpam28 = setTimeout(function(){ ChatSpamFC28(); }, 800);
}
function ChatSpamFC28() {
    ns(["ch", ["Heard shawty still in love"]]);
    clearTimeout(ChatSpam28);
    ChatSpam29 = setTimeout(function(){ ChatSpamFC29(); }, 1100);
}
function ChatSpamFC29() {
    ns(["ch", ["through the grape vine"]]);
    clearTimeout(ChatSpam29);
    ChatSpam30 = setTimeout(function(){ ChatSpamFC30(); }, 800);
}
function ChatSpamFC30() {
    ns(["ch", ["Heard shawty in love"]]);
    clearTimeout(ChatSpam30);
    ChatSpam31 = setTimeout(function(){ ChatSpamFC31(); }, 1200);
}
function ChatSpamFC31() {
    ns(["ch", ["through the grape vine"]]);
    clearTimeout(ChatSpam31);
    ChatSpam32 = setTimeout(function(){ ChatSpamFC32(); }, 800);
}
function ChatSpamFC32() {
    ns(["ch", ["Mix a little bit of weed with"]]);
    clearTimeout(ChatSpam32);
    ChatSpam33 = setTimeout(function(){ ChatSpamFC33(); }, 1200);
}
function ChatSpamFC33() {
    ns(["ch", ["a little bit of cash"]]);
    clearTimeout(ChatSpam33);
    ChatSpam34 = setTimeout(function(){ ChatSpamFC34(); }, 800);
}
function ChatSpamFC34() {
    ns(["ch", ["With a little bit of this,"]]);
    clearTimeout(ChatSpam34);
    ChatSpam35 = setTimeout(function(){ ChatSpamFC35(); }, 1200);
}
function ChatSpamFC35() {
    ns(["ch", ["with a little bit of that"]]);
    clearTimeout(ChatSpam35);
    ChatSpam36 = setTimeout(function(){ ChatSpamFC36(); }, 800);
}
function ChatSpamFC36() {
    ns(["ch", ["We gon' be al-, we gon' be al-"]]);
    clearTimeout(ChatSpam36);
...
function ChatSpamFC38() {
    ns(["ch", ["Mix a little bit of weed with"]]);
    clearTimeout(ChatSpam38);
    ChatSpam39 = setTimeout(function(){ ChatSpamFC39(); }, 1200);
}
function ChatSpamFC39() {
    ns(["ch", ["a little bit of cash"]]);
    clearTimeout(ChatSpam39);
    ChatSpam0 = setTimeout(function(){ ChatSpamFC40(); }, 800);
}
function ChatSpamFC40() {
    ns(["ch", ["With a little bit of this,"]]);
    clearTimeout(ChatSpam40);
    ChatSpam1 = setTimeout(function(){ ChatSpamFC41(); }, 1200);
}
function ChatSpamFC41() {
    ns(["ch", ["with a little bit of that"]]);
    clearTimeout(ChatSpam41);
    ChatSpam1 = setTimeout(function(){ ChatSpamFC42(); }, 800);
}
function ChatSpamFC42() {
    ns(["ch", ["We gon' be al-, we gon' be alr"]]);
    clearTimeout(ChatSpam42);
...
function ChatSpamFC44() {
    ns(["ch", ["Mix a little bit of weed"]]);
    clearTimeout(ChatSpam44);
    ChatSpam5 = setTimeout(function(){ ChatSpamFC45(); }, 1200);
}
function ChatSpamFC45() {
    ns(["ch", ["with a little bit of cash"]]);
    clearTimeout(ChatSpam45);
    ChatSpam6 = setTimeout(function(){ ChatSpamFC46(); }, 800);
}
function ChatSpamFC46() {
    ns(["ch", ["With a little bit of this,"]]);
    clearTimeout(ChatSpam46);
    ChatSpam7 = setTimeout(function(){ ChatSpamFC47(); }, 1200);
}
function ChatSpamFC47() {
    ns(["ch", ["with a little bit of that"]]);
    clearTimeout(ChatSpam47);
    ChatSpam8 = setTimeout(function(){ ChatSpamFC48(); }, 800);
}
...
function ChatSpamFC49() {
    ns(["ch", ["We gon' be alr, we gon' be al-"]]);
    clearTimeout(ChatSpam49);
...
function ChatSpamFC50() {
    ns(["ch", ["Mix a little bit of weed"]]);
    clearTimeout(ChatSpam50);
    ChatSpam11 = setTimeout(function(){ ChatSpamFC51(); }, 1200);
}
function ChatSpamFC51() {
    ns(["ch", ["with a little bit of cash"]]);
    clearTimeout(ChatSpam51);
    ChatSpam12 = setTimeout(function(){ ChatSpamFC52(); }, 800);
}
function ChatSpamFC52() {
    ns(["ch", ["With a little bit of this,"]]);
    clearTimeout(ChatSpam52);
    ChatSpam13 = setTimeout(function(){ ChatSpamFC53(); }, 1200);
}
function ChatSpamFC53() {
    ns(["ch", ["with a little bit of that"]]);
    clearTimeout(ChatSpam53);
    ChatSpam14 = setTimeout(function(){ ChatSpamFC54(); }, 800);
}
...
function ChatSpamFC55() {
    ns(["ch", ["We gon' be al-, we gon' be al-"]]);
    clearTimeout(ChatSpam55);
    ChatSpam16 = setTimeout(function(){ ChatSpamFC56(); }, 2500);
}
function ChatSpamFC56() {
    ns(["ch", ["Why am I so in love?"]]);
    clearTimeout(ChatSpam56);
    ChatSpam17 = setTimeout(function(){ ChatSpamFC57(); }, 4000);
}
function ChatSpamFC57() {
    ns(["ch", ["I dont know why"]]);
    clearTimeout(ChatSpam57);
    ChatSpam18 = setTimeout(function(){ ChatSpamFC58(); }, 3550);
}
function ChatSpamFC58() {
    ns(["ch", ["Why am I so in love?"]]);
    clearTimeout(ChatSpam58);
    ChatSpam19 = setTimeout(function(){ ChatSpamFC59(); }, 3800);
}
function ChatSpamFC59() {
    ns(["ch", ["I dont know why"]]);
    clearTimeout(ChatSpam59);
    ChatSpam20 = setTimeout(function(){ ChatSpamFC60(); }, 4250);
}
function ChatSpamFC60() {
    ns(["ch", ["She said I, oh, I, am falling"]]);
    clearTimeout(ChatSpam60);
    ChatSpam21 = setTimeout(function(){ ChatSpamFC61(); }, 5000);
}
function ChatSpamFC61() {
    ns(["ch", ["for you, falling for you"]]);
    clearTimeout(ChatSpam61);
    ChatSpam22 = setTimeout(function(){ ChatSpamFC62(); }, 2500);
}
function ChatSpamFC62() {
    ns(["ch", ["I, oh, I, am falling for you,"]]);
    clearTimeout(ChatSpam62);
    ChatSpam23 = setTimeout(function(){ ChatSpamFC63(); }, 5650);
}
function ChatSpamFC63() {
    ns(["ch", ["falling for you"]]);
    clearTimeout(ChatSpam63);
    ChatSpam24 = setTimeout(function(){ ChatSpamFC64(); }, 2500);
}
function ChatSpamFC64() {
    ns(["ch", ["I, oh, I, am falling for you,"]]);
    clearTimeout(ChatSpam64);
    ChatSpam25 = setTimeout(function(){ ChatSpamFC65(); }, 5600);
}
function ChatSpamFC65() {
    ns(["ch", ["falling for you"]]);
    clearTimeout(ChatSpam65);
    ChatSpam26 = setTimeout(function(){ ChatSpamFC66(); }, 2500);
}
function ChatSpamFC66() {
    ns(["ch", ["I, oh, I, am falling for you,"]]);
    clearTimeout(ChatSpam66);
    ChatSpam27 = setTimeout(function(){ ChatSpamFC67(); }, 5600);
}
function ChatSpamFC67() {
    ns(["ch", ["falling for you"]]);
    clearTimeout(ChatSpam67);
    ChatSpam28 = setTimeout(function(){ ChatSpamFC68(); }, 2700);
}
function ChatSpamFC68() {
    ns(["ch", ["Why am I so in love?"]]);
    clearTimeout(ChatSpam68);
    ChatSpam29 = setTimeout(function(){ ChatSpamFC69(); }, 3500);
}
function ChatSpamFC69() {
    ns(["ch", ["Why am I so in love?"]]);
    clearTimeout(ChatSpam69);
    ChatSpam30 = setTimeout(function(){ ChatSpamFC70(); }, 4000);
}
function ChatSpamFC70() {
    ns(["ch", ["Why am I so in love?"]]);
    clearTimeout(ChatSpam70);
    ChatSpam31 = setTimeout(function(){ ChatSpamFC71(); }, 4000);
}
function ChatSpamFC71() {
    ns(["ch", ["I don't know why"]]);
    clearTimeout(ChatSpam71);
    ChatSpam32 = setTimeout(function(){ ChatSpamFC72(); }, 5000);
}
function ChatSpamFC72() {
    ns(["ch", ["Why am I so in love?"]]);
    clearTimeout(ChatSpam72);
    ChatSpam33 = setTimeout(function(){ ChatSpamFC73(); }, 3000);
}
function ChatSpamFC73() {
    ns(["ch", ["Why am I so in love?"]]);
    clearTimeout(ChatSpam73);
    ChatSpam34 = setTimeout(function(){ ChatSpamFC74(); }, 3000);
}
function ChatSpamFC74() {
    ns(["ch", ["Why am I so in love?"]]);
    clearTimeout(ChatSpam74);
    ChatSpam35 = setTimeout(function(){ ChatSpamFC75(); }, 4200);
}
function ChatSpamFC75() {
    ns(["ch", ["I don't know why"]]);
    clearTimeout(ChatSpam75);
    ChatSpam36 = setTimeout(function(){ ChatSpamFC76(); }, 5000);
}
...
const pDisplay = $("#pingDisplay");
pDisplay.css("left", "45px");
pDisplay.css("display", "block");
$("body").append(pDisplay);
...
(function() {
    ...
    function z1() {
                ns(["13c", [1, 49, 0]]);
                ns(["13c", [0, 49, 0]]);
        if (isEnemyNear == true && !click && !click2) {
            for (let i = 0; i < 4; i++) {
                ns(["13c", [0, 49, 0]]);
            }
        }
        clearTimeout(an1);
        an2 = setTimeout(function() {
            z2();
        }, 70);
    }
    function z2() {
